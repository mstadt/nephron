...
female_nhe50_file = './female_ncc70_check'
female_nhe80_file = './female_ncc100_check'

male_normal_file = './male_normal_check'
male_nhe50_file = './male_ncc70_check'
male_nhe80_file = './male_ncc100_check'
...
male_sup_nhe50=axarr[0].bar(np.arange(len(segment[4:6]))+bar_width,male_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='Male 70% NCC inhib')
...
male_sup_nhe80=axarr[0].bar(np.arange(len(segment[4:6]))+2*bar_width,male_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise',label='Male 100% NCC inhib')
...
#axarr[0].set_title('NCC inhibitions',fontsize = 50)
...
# axarr[0,1].set_xticks(np.arange(len(segment[4:]))+1*bar_width)
# axarr[0,1].set_xticklabels(segment[4:],fontsize=40)
# axarr[0,1].tick_params(axis='both',labelsize=40)
# axarr[0,1].set_ylim(0,17)
# axarr[0,1].set_title('Female',fontsize = 50)
# #ax.set_xlabel('Segment',fontsize=20)
# axarr[0,1].set_ylabel('Na$^+$ delivery ($\mu$mol/min)',fontsize=40)
...
# male_sup_nhe50_inset=axins.bar(np.arange(len(segment[:6]))+bar_width,male_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='70% NCC inhib')
...
# male_sup_nhe80_inset=axins.bar(np.arange(len(segment[:6]))+2*bar_width,male_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise',label='100% NCC inhib')
...
# Female_sup_nhe50_inset=axins.bar(np.arange(len(segment[:6]))+1*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='70% NCC inhib')
...
# Female_sup_nhe80_inset=axins.bar(np.arange(len(segment[:6]))+2*bar_width,female_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink',label='100% NCC inhib')
...
Female_sup_nhe50=axarr[1].bar(np.arange(len(segment[4:6]))+4*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female 70% NCC inhib')
...
Female_sup_nhe80=axarr[1].bar(np.arange(len(segment[4:6]))+5*bar_width,female_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink',label='Female 100% NCC inhib')
...
plt.savefig('delivery_comp_panel_ncc_female_male',bbox_inches='tight')