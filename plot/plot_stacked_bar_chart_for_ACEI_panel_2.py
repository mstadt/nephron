...
male_sup_nhe50=axarr[0,0].bar(np.arange(len(segment[:6]))+bar_width,male_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='Male with ACEi')
...
Female_sup=axarr[0,1].bar(np.arange(len(segment[:6]))+2*bar_width,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female Baseline')
...
Female_sup_nhe50=axarr[0,1].bar(np.arange(len(segment[:6]))+3*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female with ACEi')
...
#     if seg == 'cnt':
#         male_delivery_number.append(0)
#         male_delivery_sup.append(neph_weight[0]*datalist_sup[-1]*solute_conversion-0.1)
#         male_delivery_jux1.append(neph_weight[1]*datalist_jux1[-1]*solute_conversion)
#         male_delivery_jux2.append(neph_weight[2]*datalist_jux2[-1]*solute_conversion)
#         male_delivery_jux3.append(neph_weight[3]*datalist_jux3[-1]*solute_conversion)
#         male_delivery_jux4.append(neph_weight[4]*datalist_jux4[-1]*solute_conversion)
...
# male_delivery_jux5_nhe50 = []
# for seg in segment_early:
#     file_sup = open(male_nhe50_file+'/female_hum_'+seg+'_flow_of_H2PO4_in_Lumen_sup.txt','r')
#     file_jux1 = open(male_nhe50_file+'/female_hum_'+seg+'_flow_of_H2PO4_in_Lumen_jux1.txt','r')
#     file_jux2 = open(male_nhe50_file+'/female_hum_'+seg+'_flow_of_H2PO4_in_Lumen_jux2.txt','r')
#     file_jux3 = open(male_nhe50_file+'/female_hum_'+seg+'_flow_of_H2PO4_in_Lumen_jux3.txt','r')
#     file_jux4 = open(male_nhe50_file+'/female_hum_'+seg+'_flow_of_H2PO4_in_Lumen_jux4.txt','r')
#     file_jux5 = open(male_nhe50_file+'/female_hum_'+seg+'_flow_of_H2PO4_in_Lumen_jux5.txt','r')
#     datalist_sup = []
#     datalist_jux1 = []
#     datalist_jux2 = []
#     datalist_jux3 = []
#     datalist_jux4 = []
#     datalist_jux5 = []
#     file_sup_2 = open(male_nhe50_file+'/female_hum_'+seg+'_flow_of_HPO4_in_Lumen_sup.txt','r')
#     file_jux1_2 = open(male_nhe50_file+'/female_hum_'+seg+'_flow_of_HPO4_in_Lumen_jux1.txt','r')
#     file_jux2_2 = open(male_nhe50_file+'/female_hum_'+seg+'_flow_of_HPO4_in_Lumen_jux2.txt','r')
#     file_jux3_2 = open(male_nhe50_file+'/female_hum_'+seg+'_flow_of_HPO4_in_Lumen_jux3.txt','r')
#     file_jux4_2 = open(male_nhe50_file+'/female_hum_'+seg+'_flow_of_HPO4_in_Lumen_jux4.txt','r')
#     file_jux5_2 = open(male_nhe50_file+'/female_hum_'+seg+'_flow_of_HPO4_in_Lumen_jux5.txt','r')
#     datalist_sup_2 = []
#     datalist_jux1_2 = []
#     datalist_jux2_2 = []
#     datalist_jux3_2 = []
...
#         male_delivery_jux5_nhe50.append(neph_weight[5]*(10**(7.4-6.8)*datalist_jux5[0]-datalist_jux5_2[0])/(1+10**(7.4-6.8))*solute_conversion)
# for seg in segment_late:
#     file_data = open(male_nhe50_file+'/female_hum_'+seg+'_flow_of_H2PO4_in_Lumen.txt','r')
#     file_data_2 = open(male_nhe50_file+'/female_hum_'+seg+'_flow_of_HPO4_in_Lumen.txt','r')
#     datalist = []
#     datalist_2 = []
#     for i in file_data:
#         line = i.split(' ')
...
# male_sup_nhe50=axarr[3,0].bar(np.arange(len(segment[:6]))+bar_width,male_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='Male')
...
# Female_sup=axarr[3,0].bar(np.arange(len(segment[:6]))+2*bar_width,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female')
# Female_jux=axarr[3,0].bar(np.arange(len(segment[:6]))+2*bar_width,[female_delivery_jux1[i]+female_delivery_jux2[i]+female_delivery_jux3[i]+female_delivery_jux4[i]+female_delivery_jux5[i] for i in range(len(female_delivery_sup))],bar_width,bottom=female_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white',label='Juxtamedullary')
# Female_later=axarr[3,0].bar(np.arange(len(segment))+2*bar_width,female_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50=axarr[3,0].bar(np.arange(len(segment[:6]))+3*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female')
# Female_jux_nhe50=axarr[3,0].bar(np.arange(len(segment[:6]))+3*bar_width,[female_delivery_jux1_nhe50[i]+female_delivery_jux2_nhe50[i]+female_delivery_jux3_nhe50[i]+female_delivery_jux4_nhe50[i]+female_delivery_jux5_nhe50[i] for i in range(len(female_delivery_sup_nhe50))],bar_width,bottom=female_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white',label='Juxtamedullary')
# Female_later_nhe50=axarr[3,0].bar(np.arange(len(segment))+3*bar_width,female_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')

# axarr[3,0].set_xticks(np.arange(len(segment))+1.5*bar_width)
...
for seg in segment_late:
    ...
    if seg == 'imcd':
        number_of_delivery = datalist[-1]
        female_delivery_number_nhe50.append(number_of_delivery*volume_conversion+0.01)
    else:
        number_of_delivery = datalist[0]
...
male_sup_nhe50=axarr[1,1].bar(np.arange(len(segment[:6]))+bar_width,male_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='Male')
male_jux_nhe50=axarr[1,1].bar(np.arange(len(segment[:6]))+bar_width,[male_delivery_jux1_nhe50[i]+male_delivery_jux2_nhe50[i]+male_delivery_jux3_nhe50[i]+male_delivery_jux4_nhe50[i]+male_delivery_jux5_nhe50[i] for i in range(len(male_delivery_sup_nhe50))],bar_width,bottom=male_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later_nhe50=axarr[1,1].bar(np.arange(len(segment))+bar_width,male_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')

Female_sup=axarr[1,1].bar(np.arange(len(segment[:6]))+2*bar_width,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female')
Female_jux=axarr[1,1].bar(np.arange(len(segment[:6]))+2*bar_width,[female_delivery_jux1[i]+female_delivery_jux2[i]+female_delivery_jux3[i]+female_delivery_jux4[i]+female_delivery_jux5[i] for i in range(len(female_delivery_sup))],bar_width,bottom=female_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white',label='Juxtamedullary')
Female_later=axarr[1,1].bar(np.arange(len(segment))+2*bar_width,female_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

Female_sup_nhe50=axarr[1,1].bar(np.arange(len(segment[:6]))+3*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female')
Female_jux_nhe50=axarr[1,1].bar(np.arange(len(segment[:6]))+3*bar_width,[female_delivery_jux1_nhe50[i]+female_delivery_jux2_nhe50[i]+female_delivery_jux3_nhe50[i]+female_delivery_jux4_nhe50[i]+female_delivery_jux5_nhe50[i] for i in range(len(female_delivery_sup_nhe50))],bar_width,bottom=female_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white',label='Juxtamedullary')
Female_later_nhe50=axarr[1,1].bar(np.arange(len(segment))+3*bar_width,female_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
#plt.show()
plt.savefig('delivery_ACEI_2',bbox_inches='tight')