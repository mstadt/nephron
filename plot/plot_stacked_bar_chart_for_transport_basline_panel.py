...
Female_sup=axarr[0,0].bar(np.arange(len(segment_transport[:6]))+bar_width,female_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female baseline')
...
#plt.show()
plt.savefig('transport_baseline',bbox_inches='tight')