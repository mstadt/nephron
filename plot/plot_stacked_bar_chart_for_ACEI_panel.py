...
female_normal_file = './Female_hum_normal'
female_nhe50_file = './ACE_Female_hum_normal'
#female_nhe80_file = './female_nhe80_check'

male_normal_file = './Male_hum_normal'
male_nhe50_file = './ACE_Male_hum_normal'
...
#print(segment[3:6],male_delivery_sup)

male_sup=axarr[0,0].bar(np.arange(len(segment[3:6])),male_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male Baseline')
male_jux=axarr[0,0].bar(np.arange(len(segment[3:6])),[male_delivery_jux1[i+3]+male_delivery_jux2[i+3]+male_delivery_jux3[i+3]+male_delivery_jux4[i+3]+male_delivery_jux5[i+3] for i in range(len(male_delivery_sup[3:]))],bar_width,bottom=male_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later=axarr[0,0].bar(np.arange(len(segment[3:])),male_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

male_sup_nhe50=axarr[0,0].bar(np.arange(len(segment[3:6]))+bar_width,male_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='Male with ACEi')
male_jux_nhe50=axarr[0,0].bar(np.arange(len(segment[3:6]))+bar_width,[male_delivery_jux1_nhe50[i+3]+male_delivery_jux2_nhe50[i+3]+male_delivery_jux3_nhe50[i+3]+male_delivery_jux4_nhe50[i+3]+male_delivery_jux5_nhe50[i+3] for i in range(len(male_delivery_sup_nhe50[3:]))],bar_width,bottom=male_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later_nhe50=axarr[0,0].bar(np.arange(len(segment[3:]))+bar_width,male_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')

Female_sup=axarr[0,0].bar(np.arange(len(segment[3:6]))+2*bar_width,female_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')
Female_jux=axarr[0,0].bar(np.arange(len(segment[3:6]))+2*bar_width,[female_delivery_jux1[i+3]+female_delivery_jux2[i+3]+female_delivery_jux3[i+3]+female_delivery_jux4[i+3]+female_delivery_jux5[i+3] for i in range(len(female_delivery_sup[3:]))],bar_width,bottom=female_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later=axarr[0,0].bar(np.arange(len(segment[3:]))+2*bar_width,female_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

Female_sup_nhe50=axarr[0,0].bar(np.arange(len(segment[3:6]))+3*bar_width,female_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
Female_jux_nhe50=axarr[0,0].bar(np.arange(len(segment[3:6]))+3*bar_width,[female_delivery_jux1_nhe50[i+3]+female_delivery_jux2_nhe50[i+3]+female_delivery_jux3_nhe50[i+3]+female_delivery_jux4_nhe50[i+3]+female_delivery_jux5_nhe50[i+3] for i in range(len(female_delivery_sup_nhe50[3:]))],bar_width,bottom=female_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later_nhe50=axarr[0,0].bar(np.arange(len(segment[3:]))+3*bar_width,female_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')

axarr[0,0].set_xticks(np.arange(len(segment[3:]))+1.5*bar_width)
axarr[0,0].set_xticklabels(segment[3:],fontsize=30)
...
# male_sup_inset=axins.bar(np.arange(len(segment[3:6])),male_delivery_sup[3:],bar_width_ins,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')
# male_jux_inset=axins.bar(np.arange(len(segment[3:6])),[male_delivery_jux1[i+3]+male_delivery_jux2[i+3]+male_delivery_jux3[i+3]+male_delivery_jux4[i+3]+male_delivery_jux5[i+3] for i in range(len(male_delivery_sup[3:]))],bar_width_ins,bottom=male_delivery_sup[3:][3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later_inset=axins.bar(np.arange(len(segment[3:])),male_delivery_number[3:],bar_width_ins,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

# male_sup_nhe50_inset=axins.bar(np.arange(len(segment[3:6]))+bar_width_ins,male_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')
# male_jux_nhe50_inset=axins.bar(np.arange(len(segment[3:6]))+bar_width_ins,[male_delivery_jux1_nhe50[i+3]+male_delivery_jux2_nhe50[i+3]+male_delivery_jux3_nhe50[i+3]+male_delivery_jux4_nhe50[i+3]+male_delivery_jux5_nhe50[i+3] for i in range(len(male_delivery_sup_nhe50[3:]))],bar_width,bottom=male_delivery_sup_nhe50[3:],,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later_nhe50_inset=axins.bar(np.arange(len(segment[3:]))+bar_width_ins,male_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')

# Female_sup_inset=axins.bar(np.arange(len(segment[3:6]))+2*bar_width_ins,female_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')
# Female_jux_inset=axins.bar(np.arange(len(segment[3:6]))+2*bar_width_ins,[female_delivery_jux1[i+3]+female_delivery_jux2[i+3]+female_delivery_jux3[i+3]+female_delivery_jux4[i+3]+female_delivery_jux5[i+3] for i in range(len(female_delivery_sup[3:]))],bar_width,bottom=female_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_inset=axins.bar(np.arange(len(segment[3:]))+2*bar_width_ins,female_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50_inset=axins.bar(np.arange(len(segment[3:6]))+3*bar_width,female_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
# Female_jux_nhe50_inset=axins.bar(np.arange(len(segment[3:6]))+3*bar_width,[female_delivery_jux1_nhe50[i+3]+female_delivery_jux2_nhe50[i+3]+female_delivery_jux3_nhe50[i+3]+female_delivery_jux4_nhe50[i+3]+female_delivery_jux5_nhe50[i+3] for i in range(len(female_delivery_sup_nhe50[3:]))],bar_width,bottom=female_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_nhe50_inset=axins.bar(np.arange(len(segment[3:]))+3*bar_width,female_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')

# axins.set_xticks(np.arange(len(segment[3:]))+1.5*bar_width_ins)
# axins.set_xticklabels(segment[3:],fontsize=30)
# axins.set_xlim(2-1.5*bar_width_ins,3+4*bar_width_ins)
...
male_sup=axarr[0,1].bar(np.arange(len(segment[3:6])),male_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')
male_jux=axarr[0,1].bar(np.arange(len(segment[3:6])),[male_delivery_jux1[i+3]+male_delivery_jux2[i+3]+male_delivery_jux3[i+3]+male_delivery_jux4[i+3]+male_delivery_jux5[i+3] for i in range(len(male_delivery_sup[3:]))],bar_width,bottom=male_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later=axarr[0,1].bar(np.arange(len(segment[3:])),male_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

male_sup_nhe50=axarr[0,1].bar(np.arange(len(segment[3:6]))+bar_width,male_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')
male_jux_nhe50=axarr[0,1].bar(np.arange(len(segment[3:6]))+bar_width,[male_delivery_jux1_nhe50[i+3]+male_delivery_jux2_nhe50[i+3]+male_delivery_jux3_nhe50[i+3]+male_delivery_jux4_nhe50[i+3]+male_delivery_jux5_nhe50[i+3] for i in range(len(male_delivery_sup_nhe50[3:]))],bar_width,bottom=male_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later_nhe50=axarr[0,1].bar(np.arange(len(segment[3:]))+bar_width,male_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')

Female_sup=axarr[0,1].bar(np.arange(len(segment[3:6]))+2*bar_width,female_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female Baseline')
Female_jux=axarr[0,1].bar(np.arange(len(segment[3:6]))+2*bar_width,[female_delivery_jux1[i+3]+female_delivery_jux2[i+3]+female_delivery_jux3[i+3]+female_delivery_jux4[i+3]+female_delivery_jux5[i+3] for i in range(len(female_delivery_sup[3:]))],bar_width,bottom=female_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later=axarr[0,1].bar(np.arange(len(segment[3:]))+2*bar_width,female_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

Female_sup_nhe50=axarr[0,1].bar(np.arange(len(segment[3:6]))+3*bar_width,female_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female with ACEi')
Female_jux_nhe50=axarr[0,1].bar(np.arange(len(segment[3:6]))+3*bar_width,[female_delivery_jux1_nhe50[i+3]+female_delivery_jux2_nhe50[i+3]+female_delivery_jux3_nhe50[i+3]+female_delivery_jux4_nhe50[i+3]+female_delivery_jux5_nhe50[i+3] for i in range(len(female_delivery_sup_nhe50[3:]))],bar_width,bottom=female_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later_nhe50=axarr[0,1].bar(np.arange(len(segment[3:]))+3*bar_width,female_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
axarr[0,1].set_xticks(np.arange(len(segment[3:]))+1.5*bar_width)
axarr[0,1].set_xticklabels(segment[3:],fontsize=30)
...
#Male_inset=axins.bar(np.arange(len(segment[3:])),male_list,bar_width_ins,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='black',label='Male')
#Female_inset=axins.bar(np.arange(len(segment[3:]))+bar_width_ins,female_list,bar_width_ins,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white',label='Female')
#axins.set_xticks(np.arange(len(segment[3:]))+0.5*bar_width_ins)
...
male_sup=axarr[1,0].bar(np.arange(len(segment[3:6])),male_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')
male_jux=axarr[1,0].bar(np.arange(len(segment[3:6])),[male_delivery_jux1[i+3]+male_delivery_jux2[i+3]+male_delivery_jux3[i+3]+male_delivery_jux4[i+3]+male_delivery_jux5[i+3] for i in range(len(male_delivery_sup[3:]))],bar_width,bottom=male_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later=axarr[1,0].bar(np.arange(len(segment[3:])),male_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

male_sup_nhe50=axarr[1,0].bar(np.arange(len(segment[3:6]))+bar_width,male_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')
male_jux_nhe50=axarr[1,0].bar(np.arange(len(segment[3:6]))+bar_width,[male_delivery_jux1_nhe50[i+3]+male_delivery_jux2_nhe50[i+3]+male_delivery_jux3_nhe50[i+3]+male_delivery_jux4_nhe50[i+3]+male_delivery_jux5_nhe50[i+3] for i in range(len(male_delivery_sup_nhe50[3:]))],bar_width,bottom=male_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later_nhe50=axarr[1,0].bar(np.arange(len(segment[3:]))+bar_width,male_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')

Female_sup=axarr[1,0].bar(np.arange(len(segment[3:6]))+2*bar_width,female_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')
Female_jux=axarr[1,0].bar(np.arange(len(segment[3:6]))+2*bar_width,[female_delivery_jux1[i+3]+female_delivery_jux2[i+3]+female_delivery_jux3[i+3]+female_delivery_jux4[i+3]+female_delivery_jux5[i+3] for i in range(len(female_delivery_sup[3:]))],bar_width,bottom=female_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later=axarr[1,0].bar(np.arange(len(segment[3:]))+2*bar_width,female_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

Female_sup_nhe50=axarr[1,0].bar(np.arange(len(segment[3:6]))+3*bar_width,female_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
Female_jux_nhe50=axarr[1,0].bar(np.arange(len(segment[3:6]))+3*bar_width,[female_delivery_jux1_nhe50[i+3]+female_delivery_jux2_nhe50[i+3]+female_delivery_jux3_nhe50[i+3]+female_delivery_jux4_nhe50[i+3]+female_delivery_jux5_nhe50[i+3] for i in range(len(female_delivery_sup_nhe50[3:]))],bar_width,bottom=female_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later_nhe50=axarr[1,0].bar(np.arange(len(segment[3:]))+3*bar_width,female_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
axarr[1,0].set_xticks(np.arange(len(segment[3:]))+1.5*bar_width)
axarr[1,0].set_xticklabels(segment[3:],fontsize=30)
...
# male_sup_inset=axins.bar(np.arange(len(segment[3:6])),male_delivery_sup[3:],bar_width_ins,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')
# male_jux_inset=axins.bar(np.arange(len(segment[3:6])),[male_delivery_jux1[i+3]+male_delivery_jux2[i+3]+male_delivery_jux3[i+3]+male_delivery_jux4[i+3]+male_delivery_jux5[i+3] for i in range(len(male_delivery_sup[3:]))],bar_width_ins,bottom=male_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later_inset=axins.bar(np.arange(len(segment[3:])),male_delivery_number[3:],bar_width_ins,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')
...
# male_sup=axarr[1,1].bar(np.arange(len(segment[3:6])),male_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')
# male_jux=axarr[1,1].bar(np.arange(len(segment[3:6])),[male_delivery_jux1[i+3]+male_delivery_jux2[i+3]+male_delivery_jux3[i+3]+male_delivery_jux4[i+3]+male_delivery_jux5[i+3] for i in range(len(male_delivery_sup[3:]))],bar_width,bottom=male_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later=axarr[1,1].bar(np.arange(len(segment[3:])),male_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

# male_sup_nhe50=axarr[1,1].bar(np.arange(len(segment[3:6]))+bar_width,male_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')
# male_jux_nhe50=axarr[1,1].bar(np.arange(len(segment[3:6]))+bar_width,[male_delivery_jux1_nhe50[i+3]+male_delivery_jux2_nhe50[i+3]+male_delivery_jux3_nhe50[i+3]+male_delivery_jux4_nhe50[i+3]+male_delivery_jux5_nhe50[i+3] for i in range(len(male_delivery_sup_nhe50[3:]))],bar_width,bottom=male_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later_nhe50=axarr[1,1].bar(np.arange(len(segment[3:]))+bar_width,male_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')

# Female_sup=axarr[1,1].bar(np.arange(len(segment[3:6]))+2*bar_width,female_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')
# Female_jux=axarr[1,1].bar(np.arange(len(segment[3:6]))+2*bar_width,[female_delivery_jux1[i+3]+female_delivery_jux2[i+3]+female_delivery_jux3[i+3]+female_delivery_jux4[i+3]+female_delivery_jux5[i+3] for i in range(len(female_delivery_sup[3:]))],bar_width,bottom=female_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later=axarr[1,1].bar(np.arange(len(segment[3:]))+2*bar_width,female_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50=axarr[1,1].bar(np.arange(len(segment[3:6]))+3*bar_width,female_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
# Female_jux_nhe50=axarr[1,1].bar(np.arange(len(segment[3:6]))+3*bar_width,[female_delivery_jux1_nhe50[i+3]+female_delivery_jux2_nhe50[i+3]+female_delivery_jux3_nhe50[i+3]+female_delivery_jux4_nhe50[i+3]+female_delivery_jux5_nhe50[i+3] for i in range(len(female_delivery_sup_nhe50[3:]))],bar_width,bottom=female_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_nhe50=axarr[1,1].bar(np.arange(len(segment[3:]))+3*bar_width,female_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
# axarr[1,1].set_xticks(np.arange(len(segment[3:]))+1.5*bar_width)
# axarr[1,1].set_xticklabels(segment[3:],fontsize=30)
# axarr[1,1].tick_params(axis='both',labelsize=30)
# #ax.set_xlabel('Segment',fontsize=20)
# axarr[1,1].set_ylabel('HCO$_3^-$ delivery (mol/Day)',fontsize=30) #Glucose
...
# male_sup=axarr[2,0].bar(np.arange(len(segment[3:6])),male_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')
# male_jux=axarr[2,0].bar(np.arange(len(segment[3:6])),[male_delivery_jux1[i+3]+male_delivery_jux2[i+3]+male_delivery_jux3[i+3]+male_delivery_jux4[i+3]+male_delivery_jux5[i+3] for i in range(len(male_delivery_sup[3:]))],bar_width,bottom=male_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later=axarr[2,0].bar(np.arange(len(segment[3:])),male_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

# male_sup_nhe50=axarr[2,0].bar(np.arange(len(segment[3:6]))+bar_width,male_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')
# male_jux_nhe50=axarr[2,0].bar(np.arange(len(segment[3:6]))+bar_width,[male_delivery_jux1_nhe50[i+3]+male_delivery_jux2_nhe50[i+3]+male_delivery_jux3_nhe50[i+3]+male_delivery_jux4_nhe50[i+3]+male_delivery_jux5_nhe50[i+3] for i in range(len(male_delivery_sup_nhe50[3:]))],bar_width,bottom=male_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later_nhe50=axarr[2,0].bar(np.arange(len(segment[3:]))+bar_width,male_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')

# Female_sup=axarr[2,0].bar(np.arange(len(segment[3:6]))+2*bar_width,female_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')
# Female_jux=axarr[2,0].bar(np.arange(len(segment[3:6]))+2*bar_width,[female_delivery_jux1[i+3]+female_delivery_jux2[i+3]+female_delivery_jux3[i+3]+female_delivery_jux4[i+3]+female_delivery_jux5[i+3] for i in range(len(female_delivery_sup[3:]))],bar_width,bottom=female_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later=axarr[2,0].bar(np.arange(len(segment[3:]))+2*bar_width,female_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50=axarr[2,0].bar(np.arange(len(segment[3:6]))+3*bar_width,female_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
# Female_jux_nhe50=axarr[2,0].bar(np.arange(len(segment[3:6]))+3*bar_width,[female_delivery_jux1_nhe50[i+3]+female_delivery_jux2_nhe50[i+3]+female_delivery_jux3_nhe50[i+3]+female_delivery_jux4_nhe50[i+3]+female_delivery_jux5_nhe50[i+3] for i in range(len(female_delivery_sup_nhe50[3:]))],bar_width,bottom=female_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_nhe50=axarr[2,0].bar(np.arange(len(segment[3:]))+3*bar_width,female_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
# axarr[2,0].set_xticks(np.arange(len(segment[3:]))+1.5*bar_width)
# axarr[2,0].set_xticklabels(segment[3:],fontsize=30)
...
# male_sup=axarr[2,1].bar(np.arange(len(segment[3:6])),male_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')
# male_jux=axarr[2,1].bar(np.arange(len(segment[3:6])),[male_delivery_jux1[i+3]+male_delivery_jux2[i+3]+male_delivery_jux3[i+3]+male_delivery_jux4[i+3]+male_delivery_jux5[i+3] for i in range(len(male_delivery_sup[3:]))],bar_width,bottom=male_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later=axarr[2,1].bar(np.arange(len(segment[3:])),male_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

# male_sup_nhe50=axarr[2,1].bar(np.arange(len(segment[3:6]))+bar_width,male_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')
# male_jux_nhe50=axarr[2,1].bar(np.arange(len(segment[3:6]))+bar_width,[male_delivery_jux1_nhe50[i+3]+male_delivery_jux2_nhe50[i+3]+male_delivery_jux3_nhe50[i+3]+male_delivery_jux4_nhe50[i+3]+male_delivery_jux5_nhe50[i+3] for i in range(len(male_delivery_sup_nhe50[3:]))],bar_width,bottom=male_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later_nhe50=axarr[2,1].bar(np.arange(len(segment[3:]))+bar_width,male_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')

# Female_sup=axarr[2,1].bar(np.arange(len(segment[3:6]))+2*bar_width,female_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')
# Female_jux=axarr[2,1].bar(np.arange(len(segment[3:6]))+2*bar_width,[female_delivery_jux1[i+3]+female_delivery_jux2[i+3]+female_delivery_jux3[i+3]+female_delivery_jux4[i+3]+female_delivery_jux5[i+3] for i in range(len(female_delivery_sup[3:]))],bar_width,bottom=female_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later=axarr[2,1].bar(np.arange(len(segment[3:]))+2*bar_width,female_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50=axarr[2,1].bar(np.arange(len(segment[3:6]))+3*bar_width,female_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
# Female_jux_nhe50=axarr[2,1].bar(np.arange(len(segment[3:6]))+3*bar_width,[female_delivery_jux1_nhe50[i+3]+female_delivery_jux2_nhe50[i+3]+female_delivery_jux3_nhe50[i+3]+female_delivery_jux4_nhe50[i+3]+female_delivery_jux5_nhe50[i+3] for i in range(len(female_delivery_sup_nhe50[3:]))],bar_width,bottom=female_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_nhe50=axarr[2,1].bar(np.arange(len(segment[3:]))+3*bar_width,female_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
# axarr[2,1].set_xticks(np.arange(len(segment[3:]))+1.5*bar_width)
# axarr[2,1].set_xticklabels(segment[3:],fontsize=30)
...
# male_sup=axarr[3,0].bar(np.arange(len(segment[3:6])),male_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male')
# male_jux=axarr[3,0].bar(np.arange(len(segment[3:6])),[male_delivery_jux1[i+3]+male_delivery_jux2[i+3]+male_delivery_jux3[i+3]+male_delivery_jux4[i+3]+male_delivery_jux5[i+3] for i in range(len(male_delivery_sup[3:]))],bar_width,bottom=male_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later=axarr[3,0].bar(np.arange(len(segment[3:])),male_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

# male_sup_nhe50=axarr[3,0].bar(np.arange(len(segment[3:6]))+bar_width,male_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='Male')
# male_jux_nhe50=axarr[3,0].bar(np.arange(len(segment[3:6]))+bar_width,[male_delivery_jux1_nhe50[i+3]+male_delivery_jux2_nhe50[i+3]+male_delivery_jux3_nhe50[i+3]+male_delivery_jux4_nhe50[i+3]+male_delivery_jux5_nhe50[i+3] for i in range(len(male_delivery_sup_nhe50[3:]))],bar_width,bottom=male_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later_nhe50=axarr[3,0].bar(np.arange(len(segment[3:]))+bar_width,male_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')

# Female_sup=axarr[3,0].bar(np.arange(len(segment[3:6]))+2*bar_width,female_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female')
# Female_jux=axarr[3,0].bar(np.arange(len(segment[3:6]))+2*bar_width,[female_delivery_jux1[i+3]+female_delivery_jux2[i+3]+female_delivery_jux3[i+3]+female_delivery_jux4[i+3]+female_delivery_jux5[i+3] for i in range(len(female_delivery_sup[3:]))],bar_width,bottom=female_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white',label='Juxtamedullary')
# Female_later=axarr[3,0].bar(np.arange(len(segment[3:]))+2*bar_width,female_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50=axarr[3,0].bar(np.arange(len(segment[3:6]))+3*bar_width,female_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female')
# #print(female_delivery_sup_nhe50[3:])
# Female_jux_nhe50=axarr[3,0].bar(np.arange(len(segment[3:6]))+3*bar_width,[female_delivery_jux1_nhe50[i+3]+female_delivery_jux2_nhe50[i+3]+female_delivery_jux3_nhe50[i+3]+female_delivery_jux4_nhe50[i+3]+female_delivery_jux5_nhe50[i+3] for i in range(len(female_delivery_sup_nhe50[3:]))],bar_width,bottom=female_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white',label='Juxtamedullary')
# #print([female_delivery_jux1_nhe50[i+3]+female_delivery_jux2_nhe50[i+3]+female_delivery_jux3_nhe50[i+3]+female_delivery_jux4_nhe50[i+3]+female_delivery_jux5_nhe50[i+3] for i in range(len(female_delivery_sup_nhe50[3:]))])
# Female_later_nhe50=axarr[3,0].bar(np.arange(len(segment[3:]))+3*bar_width,female_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
# #print(female_delivery_number_nhe50[3:])

# axarr[3,0].set_xticks(np.arange(len(segment[3:]))+1.5*bar_width)
# axarr[3,0].set_xticklabels(segment[3:],fontsize=30)
...
male_sup=axarr[1,1].bar(np.arange(len(segment[3:6])),male_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male')
male_jux=axarr[1,1].bar(np.arange(len(segment[3:6])),[male_delivery_jux1[i+3]+male_delivery_jux2[i+3]+male_delivery_jux3[i+3]+male_delivery_jux4[i+3]+male_delivery_jux5[i+3] for i in range(len(male_delivery_sup[3:]))],bar_width,bottom=male_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later=axarr[1,1].bar(np.arange(len(segment[3:])),male_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

male_sup_nhe50=axarr[1,1].bar(np.arange(len(segment[3:6]))+bar_width,male_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='Male')
male_jux_nhe50=axarr[1,1].bar(np.arange(len(segment[3:6]))+bar_width,[male_delivery_jux1_nhe50[i+3]+male_delivery_jux2_nhe50[i+3]+male_delivery_jux3_nhe50[i+3]+male_delivery_jux4_nhe50[i+3]+male_delivery_jux5_nhe50[i+3] for i in range(len(male_delivery_sup_nhe50[3:]))],bar_width,bottom=male_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later_nhe50=axarr[1,1].bar(np.arange(len(segment[3:]))+bar_width,male_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')

Female_sup=axarr[1,1].bar(np.arange(len(segment[3:6]))+2*bar_width,female_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female')
Female_jux=axarr[1,1].bar(np.arange(len(segment[3:6]))+2*bar_width,[female_delivery_jux1[i+3]+female_delivery_jux2[i+3]+female_delivery_jux3[i+3]+female_delivery_jux4[i+3]+female_delivery_jux5[i+3] for i in range(len(female_delivery_sup[3:]))],bar_width,bottom=female_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white',label='Juxtamedullary')
Female_later=axarr[1,1].bar(np.arange(len(segment[3:]))+2*bar_width,female_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

Female_sup_nhe50=axarr[1,1].bar(np.arange(len(segment[3:6]))+3*bar_width,female_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female')
Female_jux_nhe50=axarr[1,1].bar(np.arange(len(segment[3:6]))+3*bar_width,[female_delivery_jux1_nhe50[i+3]+female_delivery_jux2_nhe50[i+3]+female_delivery_jux3_nhe50[i+3]+female_delivery_jux4_nhe50[i+3]+female_delivery_jux5_nhe50[i+3] for i in range(len(female_delivery_sup_nhe50[3:]))],bar_width,bottom=female_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white',label='Juxtamedullary')
Female_later_nhe50=axarr[1,1].bar(np.arange(len(segment[3:]))+3*bar_width,female_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
axarr[1,1].tick_params(axis='both',labelsize=30)
#ax.set_xlabel('Segment',fontsize=20)
axarr[1,1].set_ylabel('Volume delivery (L/Day)',fontsize=30)
#axarr[3,1].legend(fontsize=30,markerscale=30)

# bar_width_ins = bar_width
# axins = inset_axes(axarr[3,1],width=2.5,height=2.5,loc=7)

# male_sup_inset=axins.bar(np.arange(len(segment[3:6])),male_delivery_sup[3:],bar_width_ins,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male')
# male_jux_inset=axins.bar(np.arange(len(segment[3:6])),[male_delivery_jux1[i+3]+male_delivery_jux2[i+3]+male_delivery_jux3[i+3]+male_delivery_jux4[i+3]+male_delivery_jux5[i+3] for i in range(len(male_delivery_sup[3:]))],bar_width_ins,bottom=male_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later_inset=axins.bar(np.arange(len(segment[3:])),male_delivery_number[3:],bar_width_ins,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

# male_sup_nhe50_inset=axins.bar(np.arange(len(segment[3:6]))+bar_width_ins,male_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='50% NHE3 inhib')
# male_jux_nhe50_inset=axins.bar(np.arange(len(segment[3:6]))+bar_width_ins,[male_delivery_jux1_nhe50[i+3]+male_delivery_jux2_nhe50[i+3]+male_delivery_jux3_nhe50[i+3]+male_delivery_jux4_nhe50[i+3]+male_delivery_jux5_nhe50[i+3] for i in range(len(male_delivery_sup_nhe50[3:]))],bar_width,bottom=male_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later_nhe50_inset=axins.bar(np.arange(len(segment[3:]))+bar_width_ins,male_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')

# Female_sup_inset=axins.bar(np.arange(len(segment[3:6]))+2*bar_width_ins,female_delivery_sup[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Baseline')
# Female_jux_inset=axins.bar(np.arange(len(segment[3:6]))+2*bar_width_ins,[female_delivery_jux1[i+3]+female_delivery_jux2[i+3]+female_delivery_jux3[i+3]+female_delivery_jux4[i+3]+female_delivery_jux5[i+3] for i in range(len(female_delivery_sup[3:]))],bar_width,bottom=female_delivery_sup[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_inset=axins.bar(np.arange(len(segment[3:]))+2*bar_width_ins,female_delivery_number[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50_inset=axins.bar(np.arange(len(segment[3:6]))+3*bar_width,female_delivery_sup_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='50% NHE3 inhib')
# Female_jux_nhe50_inset=axins.bar(np.arange(len(segment[3:6]))+3*bar_width,[female_delivery_jux1_nhe50[i+3]+female_delivery_jux2_nhe50[i+3]+female_delivery_jux3_nhe50[i+3]+female_delivery_jux4_nhe50[i+3]+female_delivery_jux5_nhe50[i+3] for i in range(len(female_delivery_sup_nhe50[3:]))],bar_width,bottom=female_delivery_sup_nhe50[3:],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_nhe50_inset=axins.bar(np.arange(len(segment[3:]))+3*bar_width,female_delivery_number_nhe50[3:],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
#plt.show()
plt.savefig('delivery_ACEI',bbox_inches='tight')