...
male_sup=axarr[0].bar(np.arange(3),[0,male_delivery_sup[0]+male_delivery_jux1[0]+male_delivery_jux2[0]+male_delivery_jux3[0]+male_delivery_jux4[0]+male_delivery_jux5[0],0],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Non-diabetic')
...
Female_sup=axarr[0].bar(np.arange(3)+2*bar_width,[0,female_delivery_sup[0]+female_delivery_jux1[0]+female_delivery_jux2[0]+female_delivery_jux3[0]+female_delivery_jux4[0]+female_delivery_jux5[0],0],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Diabetic,[Glu]=20mM')
...
axarr[0].set_xticks(np.arange(3)+0.5*bar_width)
axarr[0].set_xticklabels(['','Filtered',''],fontsize=30)
axarr[0].tick_params(axis='both',labelsize=30)
#ax.set_xlabel('Segment',fontsize=20)
axarr[0].set_ylabel('Filtered Glucose (mol/Day)',fontsize=30)
#axarr[0].legend(fontsize=30,markerscale=30)
axarr[0].get_xaxis().set_visible(False)
axarr[0].set_ylim(0,3.9)

male_later=axarr[1].bar(np.arange(3),[male_delivery_number[0],male_delivery_number[-1],0],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')
male_later_nhe50=axarr[1].bar(np.arange(3)+bar_width,[male_delivery_number_nhe50[0],male_delivery_number_nhe50[-1],0],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')
Female_later=axarr[1].bar(np.arange(3)+2*bar_width,[female_delivery_number[0],female_delivery_number[-1],0],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

axarr[1].set_xticks(np.arange(3)+0.5*bar_width)
axarr[1].set_xticklabels(['','Excretion',''],fontsize=30)
axarr[1].tick_params(axis='both',labelsize=30)
#ax.set_xlabel('Segment',fontsize=20)
axarr[1].set_ylabel('Excretion (mol/Day)',fontsize=30)
#axarr[1].legend(fontsize=30,markerscale=30)
axarr[1].get_xaxis().set_visible(False)
axarr[1].set_ylim(0,3.9)
# bar_width_ins = bar_width
# axins = inset_axes(axarr[0],width=2.5,height=2.5,loc=7)
...
#print(male_transport_number_reformed_jux1[1]+male_transport_number_reformed_jux2[1]+male_transport_number_reformed_jux3[1]+male_transport_number_reformed_jux4[1]+male_transport_number_reformed_jux5[1])
print(male_transport_number_reformed_sup[1])
male_sup=axarr[2].bar(np.arange(4),[0,male_transport_number_reformed_sup[0]+male_transport_number_reformed_jux1[0]+male_transport_number_reformed_jux2[0]+male_transport_number_reformed_jux3[0]+male_transport_number_reformed_jux4[0]+male_transport_number_reformed_jux5[0],male_transport_number_reformed_sup[1]+male_transport_number_reformed_jux1[1]+male_transport_number_reformed_jux2[1]+male_transport_number_reformed_jux3[1]+male_transport_number_reformed_jux4[1]+male_transport_number_reformed_jux5[1],0],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Non-diabetic women')
#male_jux=axarr[1].bar(np.arange(2),[male_transport_number_reformed_jux1[0]+male_transport_number_reformed_jux2[0]+male_transport_number_reformed_jux3[0]+male_transport_number_reformed_jux4[0]+male_transport_number_reformed_jux5[0],male_transport_number_reformed_jux1[1]+male_transport_number_reformed_jux2[1]+male_transport_number_reformed_jux3[1]+male_transport_number_reformed_jux4[1]+male_transport_number_reformed_jux5[1]],bar_width,bottom=[male_transport_number_reformed_sup[0],male_transport_number_reformed_sup[1]],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
...
#male_later=axarr[1].bar(np.arange(len(segment_transport)),male_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

#print(male_transport_number_reformed_jux1_nhe50[1]+male_transport_number_reformed_jux2_nhe50[1]+male_transport_number_reformed_jux3_nhe50[1]+male_transport_number_reformed_jux4_nhe50[1]+male_transport_number_reformed_jux5_nhe50[1])
print(male_transport_number_reformed_sup_nhe50[1])
male_sup_nhe50=axarr[2].bar(np.arange(4)+bar_width,[0,male_transport_number_reformed_sup_nhe50[0]+male_transport_number_reformed_jux1_nhe50[0]+male_transport_number_reformed_jux2_nhe50[0]+male_transport_number_reformed_jux3_nhe50[0]+male_transport_number_reformed_jux4_nhe50[0]+male_transport_number_reformed_jux5_nhe50[0],male_transport_number_reformed_sup_nhe50[1]+male_transport_number_reformed_jux1_nhe50[1]+male_transport_number_reformed_jux2_nhe50[1]+male_transport_number_reformed_jux3_nhe50[1]+male_transport_number_reformed_jux4_nhe50[1]+male_transport_number_reformed_jux5_nhe50[1],0],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='Moderate diabetes women')
#male_jux=axarr[1].bar(np.arange(2),[male_transport_number_reformed_jux1[0]+male_transport_number_reformed_jux2[0]+male_transport_number_reformed_jux3[0]+male_transport_number_reformed_jux4[0]+male_transport_number_reformed_jux5[0],male_transport_number_reformed_jux1[1]+male_transport_number_reformed_jux2[1]+male_transport_number_reformed_jux3[1]+male_transport_number_reformed_jux4[1]+male_transport_number_reformed_jux5[1]],bar_width,bottom=[male_transport_number_reformed_sup[0],male_transport_number_reformed_sup[1]],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
#male_jux2=ax.bar(np.arange(len(segment_transport[:4])),male_transport_number_reformed_jux2,bar_width,bottom=[male_transport_number_reformed_sup[i]+male_transport_number_reformed_jux1[i] for i in range(len(male_transport_number_reformed_sup))],align='center',alpha=0.8,linewidth=2,color='cyan',label='Male juxtamedullary type 2')
#male_jux3=ax.bar(np.arange(len(segment_transport[:4])),male_transport_number_reformed_jux3,bar_width,bottom=[male_transport_number_reformed_sup[i]+male_transport_number_reformed_jux1[i]+male_transport_number_reformed_jux2[i] for i in range(len(male_transport_number_reformed_sup))],align='center',alpha=0.8,linewidth=2,color='darkturquoise',label='Male juxtamedullary type 3')
#male_jux4=ax.bar(np.arange(len(segment_transport[:4])),male_transport_number_reformed_jux4,bar_width,bottom=[male_transport_number_reformed_sup[i]+male_transport_number_reformed_jux1[i]+male_transport_number_reformed_jux2[i]+male_transport_number_reformed_jux3[i] for i in range(len(male_transport_number_reformed_sup))],align='center',alpha=0.8,linewidth=2,color='powderblue',label='Male juxtamedullary type 4')
...
Female_sup=axarr[2].bar(np.arange(4)+2*bar_width,[0,female_transport_number_reformed_sup[0]+female_transport_number_reformed_jux1[0]+female_transport_number_reformed_jux2[0]+female_transport_number_reformed_jux3[0]+female_transport_number_reformed_jux4[0]+female_transport_number_reformed_jux5[0],female_transport_number_reformed_sup[1]+female_transport_number_reformed_jux1[1]+female_transport_number_reformed_jux2[1]+female_transport_number_reformed_jux3[1]+female_transport_number_reformed_jux4[1]+female_transport_number_reformed_jux5[1],0],bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Severe diabetes women')
#Female_jux=axarr[1].bar(np.arange(2)+bar_width,[female_transport_number_reformed_jux1[0]+female_transport_number_reformed_jux2[0]+female_transport_number_reformed_jux3[0]+female_transport_number_reformed_jux4[0]+female_transport_number_reformed_jux5[0],female_transport_number_reformed_jux1[1]+female_transport_number_reformed_jux2[1]+female_transport_number_reformed_jux3[1]+female_transport_number_reformed_jux4[1]+female_transport_number_reformed_jux5[1]],bar_width,bottom=[female_transport_number_reformed_sup[0],female_transport_number_reformed_sup[1]],align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
...
#Female_later=axarr[1].bar(np.arange(len(segment_transport))+bar_width,female_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

axarr[2].set_xticks(np.arange(4)+1*bar_width)
axarr[2].set_xticklabels(['','PCT','S3',''],fontsize=30)
axarr[2].tick_params(axis='both',labelsize=30)
#ax.set_xlabel('Segment',fontsize=20)
axarr[2].set_ylabel('Proximal transport (mol/Day)',fontsize=30)
axarr[2].set_ylim(0,3.9)
axarr[2].legend(fontsize=30,markerscale=30)

# bar_width_ins = bar_width
# axins = inset_axes(axarr[1],width=2.5,height=2.5,loc=7)
...
axarr[0].text(-0.7,axarr[0].get_ylim()[1],'A',size=40,weight='bold')
axarr[1].text(-0.7,axarr[1].get_ylim()[1],'B',size=40,weight='bold')
axarr[2].text(-0.5,axarr[1].get_ylim()[1],'C',size=40,weight='bold')
