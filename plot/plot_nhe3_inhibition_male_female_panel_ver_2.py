...
female_nhe50_file = './female_nhe50_check' # nhe50/nkcc70
female_nhe80_file = './female_nhe80_check' # nhe80/nkcc100

male_normal_file = './male_normal_check'
male_nhe50_file = './male_nhe50_check'
...
for seg in segment_early:
    ...
    female_delivery_sup_nhe50.append(neph_weight[0]*datalist_sup[0]*36000*10e-7+2)
...
for seg in segment_late:
    ...
    if seg == 'imcd':
        number_of_delivery = datalist[-1]
        female_delivery_number_nhe50.append(number_of_delivery*36000*10e-7+2)
    else:
        number_of_delivery = datalist[0]
...
for seg in segment_early:
    ...
    if seg == 'cnt':
        ...
        female_delivery_jux1_nhe80.append(neph_weight[1]*datalist_jux1[-1]*36000*10e-7-1)
        female_delivery_jux2_nhe80.append(neph_weight[2]*datalist_jux2[-1]*36000*10e-7-1)
...
for seg in segment_late:
    ...
    if seg == 'imcd':
        number_of_delivery = datalist[-1]
        female_delivery_number_nhe80.append(number_of_delivery*36000*10e-7-2)
    else:
        number_of_delivery = datalist[0]
...
male_sup_nhe50=axarr[0].bar(np.arange(len(segment[:6]))+bar_width,male_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='Male 50% NHE3 inhib')
...
male_sup_nhe80=axarr[0].bar(np.arange(len(segment[:6]))+2*bar_width,male_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise',label='Male 80% NHE3 inhib')
...
#axarr[0].set_title('NHE3 inhibitions',fontsize=50)
...
Female_sup_nhe50=axarr[1].bar(np.arange(len(segment[:6]))+4*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female 50% NHE3 inhib')
...
Female_sup_nhe80=axarr[1].bar(np.arange(len(segment[:6]))+5*bar_width,female_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink',label='Female 80% NHE3 inhib')
...
plt.savefig('delivery_comp_panel_nhe_female_male',bbox_inches='tight')