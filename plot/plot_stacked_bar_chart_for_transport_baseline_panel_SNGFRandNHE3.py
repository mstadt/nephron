...
female_normal_file = './Female_hum_GFR'
female_nhe50_file = './Female_hum_SNGFRandNHE3'
#female_nhe80_file = './female_nhe80_check'

male_normal_file = './Male_hum_SNGFRandNHE3'
...
male_sup=axarr[0,0].bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,male_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male')
male_jux=axarr[0,0].bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,[male_transport_number_reformed_jux1[i]+male_transport_number_reformed_jux2[i]+male_transport_number_reformed_jux3[i]+male_transport_number_reformed_jux4[i]+male_transport_number_reformed_jux5[i] for i in range(len(male_transport_number_reformed_sup))],bar_width,bottom=male_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
male_later=axarr[0,0].bar(np.arange(len(segment_transport))-0.5*bar_width,male_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')
...
Female_sup=axarr[0,0].bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,female_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Non-adaptive female')
Female_jux=axarr[0,0].bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,[female_transport_number_reformed_jux1[i]+female_transport_number_reformed_jux2[i]+female_transport_number_reformed_jux3[i]+female_transport_number_reformed_jux4[i]+female_transport_number_reformed_jux5[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
Female_later=axarr[0,0].bar(np.arange(len(segment_transport))+0.5*bar_width,female_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

Female_sup_nhe50=axarr[0,0].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,female_transport_number_reformed_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Adaptive female')
Female_jux_nhe50=axarr[0,0].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,[female_transport_number_reformed_jux1_nhe50[i]+female_transport_number_reformed_jux2_nhe50[i]+female_transport_number_reformed_jux3_nhe50[i]+female_transport_number_reformed_jux4_nhe50[i]+female_transport_number_reformed_jux5_nhe50[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
Female_later_nhe50=axarr[0,0].bar(np.arange(len(segment_transport))+1.5*bar_width,female_transport_number_reformed_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
# axins = inset_axes(axarr[0,0],width=4,height=4,loc=7)

# male_sup_inset=axins.bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,male_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male')
# male_jux_inset=axins.bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,[male_transport_number_reformed_jux1[i]+male_transport_number_reformed_jux2[i]+male_transport_number_reformed_jux3[i]+male_transport_number_reformed_jux4[i]+male_transport_number_reformed_jux5[i] for i in range(len(male_transport_number_reformed_sup))],bar_width,bottom=male_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
# male_later_inset=axins.bar(np.arange(len(segment_transport))-0.5*bar_width,male_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

# Female_sup_inset=axins.bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,female_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female')
# Female_jux_inset=axins.bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,[female_transport_number_reformed_jux1[i]+female_transport_number_reformed_jux2[i]+female_transport_number_reformed_jux3[i]+female_transport_number_reformed_jux4[i]+female_transport_number_reformed_jux5[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
# Female_later_inset=axins.bar(np.arange(len(segment_transport))+0.5*bar_width,female_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50_inset=axins.bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,female_transport_number_reformed_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female, "pregnancy"')
# Female_jux_nhe50_inset=axins.bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,[female_transport_number_reformed_jux1_nhe50[i]+female_transport_number_reformed_jux2_nhe50[i]+female_transport_number_reformed_jux3_nhe50[i]+female_transport_number_reformed_jux4_nhe50[i]+female_transport_number_reformed_jux5_nhe50[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
# Female_later_nhe50_inset=axins.bar(np.arange(len(segment_transport))+1.5*bar_width,female_transport_number_reformed_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')


# axins.set_xticks(np.arange(len(segment_transport))+0.5*bar_width_ins)
# axins.set_xticklabels(segment_transport,fontsize=30)
# axins.set_xlim(5-1.5*bar_width_ins,6+2.5*bar_width_ins)
...
male_sup=axarr[0,1].bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,male_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male, SNGFR inc')
male_jux=axarr[0,1].bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,[male_transport_number_reformed_jux1[i]+male_transport_number_reformed_jux2[i]+male_transport_number_reformed_jux3[i]+male_transport_number_reformed_jux4[i]+male_transport_number_reformed_jux5[i] for i in range(len(male_transport_number_reformed_sup))],bar_width,bottom=male_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
male_later=axarr[0,1].bar(np.arange(len(segment_transport))-0.5*bar_width,male_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

Female_sup=axarr[0,1].bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,female_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female, SNGFR inc')
Female_jux=axarr[0,1].bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,[female_transport_number_reformed_jux1[i]+female_transport_number_reformed_jux2[i]+female_transport_number_reformed_jux3[i]+female_transport_number_reformed_jux4[i]+female_transport_number_reformed_jux5[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
Female_later=axarr[0,1].bar(np.arange(len(segment_transport))+0.5*bar_width,female_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

Female_sup_nhe50=axarr[0,1].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,female_transport_number_reformed_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female, "pregnancy"')
Female_jux_nhe50=axarr[0,1].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,[female_transport_number_reformed_jux1_nhe50[i]+female_transport_number_reformed_jux2_nhe50[i]+female_transport_number_reformed_jux3_nhe50[i]+female_transport_number_reformed_jux4_nhe50[i]+female_transport_number_reformed_jux5_nhe50[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
Female_later_nhe50=axarr[0,1].bar(np.arange(len(segment_transport))+1.5*bar_width,female_transport_number_reformed_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
male_sup=axarr[1,0].bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,male_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male, SNGFR inc')
male_jux=axarr[1,0].bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,[male_transport_number_reformed_jux1[i]+male_transport_number_reformed_jux2[i]+male_transport_number_reformed_jux3[i]+male_transport_number_reformed_jux4[i]+male_transport_number_reformed_jux5[i] for i in range(len(male_transport_number_reformed_sup))],bar_width,bottom=male_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
male_later=axarr[1,0].bar(np.arange(len(segment_transport))-0.5*bar_width,male_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

Female_sup=axarr[1,0].bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,female_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female, SNGFR inc')
Female_jux=axarr[1,0].bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,[female_transport_number_reformed_jux1[i]+female_transport_number_reformed_jux2[i]+female_transport_number_reformed_jux3[i]+female_transport_number_reformed_jux4[i]+female_transport_number_reformed_jux5[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
Female_later=axarr[1,0].bar(np.arange(len(segment_transport))+0.5*bar_width,female_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

Female_sup_nhe50=axarr[1,0].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,female_transport_number_reformed_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female, "pregnancy"')
Female_jux_nhe50=axarr[1,0].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,[female_transport_number_reformed_jux1_nhe50[i]+female_transport_number_reformed_jux2_nhe50[i]+female_transport_number_reformed_jux3_nhe50[i]+female_transport_number_reformed_jux4_nhe50[i]+female_transport_number_reformed_jux5_nhe50[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
Female_later_nhe50=axarr[1,0].bar(np.arange(len(segment_transport))+1.5*bar_width,female_transport_number_reformed_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
# bar_width_ins = bar_width
# axins = inset_axes(axarr[1,0],width=4,height=4,loc=7)
...
# male_sup=axarr[1,1].bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,male_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male, SNGFR inc')
# male_jux=axarr[1,1].bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,[male_transport_number_reformed_jux1[i]+male_transport_number_reformed_jux2[i]+male_transport_number_reformed_jux3[i]+male_transport_number_reformed_jux4[i]+male_transport_number_reformed_jux5[i] for i in range(len(male_transport_number_reformed_sup))],bar_width,bottom=male_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
# male_later=axarr[1,1].bar(np.arange(len(segment_transport))-0.5*bar_width,male_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

# Female_sup=axarr[1,1].bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,female_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female, SNGFR inc')
# Female_jux=axarr[1,1].bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,[female_transport_number_reformed_jux1[i]+female_transport_number_reformed_jux2[i]+female_transport_number_reformed_jux3[i]+female_transport_number_reformed_jux4[i]+female_transport_number_reformed_jux5[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
# Female_later=axarr[1,1].bar(np.arange(len(segment_transport))+0.5*bar_width,female_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50=axarr[1,1].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,female_transport_number_reformed_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female, "pregnancy"')
# Female_jux_nhe50=axarr[1,1].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,[female_transport_number_reformed_jux1_nhe50[i]+female_transport_number_reformed_jux2_nhe50[i]+female_transport_number_reformed_jux3_nhe50[i]+female_transport_number_reformed_jux4_nhe50[i]+female_transport_number_reformed_jux5_nhe50[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
# Female_later_nhe50=axarr[1,1].bar(np.arange(len(segment_transport))+1.5*bar_width,female_transport_number_reformed_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
# male_sup=axarr[2,0].bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,male_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male, SNGFR inc')
# male_jux=axarr[2,0].bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,[male_transport_number_reformed_jux1[i]+male_transport_number_reformed_jux2[i]+male_transport_number_reformed_jux3[i]+male_transport_number_reformed_jux4[i]+male_transport_number_reformed_jux5[i] for i in range(len(male_transport_number_reformed_sup))],bar_width,bottom=male_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
# male_later=axarr[2,0].bar(np.arange(len(segment_transport))-0.5*bar_width,male_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

# Female_sup=axarr[2,0].bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,female_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female, SNGFR inc')
# Female_jux=axarr[2,0].bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,[female_transport_number_reformed_jux1[i]+female_transport_number_reformed_jux2[i]+female_transport_number_reformed_jux3[i]+female_transport_number_reformed_jux4[i]+female_transport_number_reformed_jux5[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
# Female_later=axarr[2,0].bar(np.arange(len(segment_transport))+0.5*bar_width,female_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50=axarr[2,0].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,female_transport_number_reformed_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female, "pregnancy"')
# Female_jux_nhe50=axarr[2,0].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,[female_transport_number_reformed_jux1_nhe50[i]+female_transport_number_reformed_jux2_nhe50[i]+female_transport_number_reformed_jux3_nhe50[i]+female_transport_number_reformed_jux4_nhe50[i]+female_transport_number_reformed_jux5_nhe50[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
# Female_later_nhe50=axarr[2,0].bar(np.arange(len(segment_transport))+1.5*bar_width,female_transport_number_reformed_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
# male_sup=axarr[2,1].bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,male_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male, SNGFR inc')
# male_jux=axarr[2,1].bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,[male_transport_number_reformed_jux1[i]+male_transport_number_reformed_jux2[i]+male_transport_number_reformed_jux3[i]+male_transport_number_reformed_jux4[i]+male_transport_number_reformed_jux5[i] for i in range(len(male_transport_number_reformed_sup))],bar_width,bottom=male_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
# male_later=axarr[2,1].bar(np.arange(len(segment_transport))-0.5*bar_width,male_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

# Female_sup=axarr[2,1].bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,female_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female, SNGFR inc')
# Female_jux=axarr[2,1].bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,[female_transport_number_reformed_jux1[i]+female_transport_number_reformed_jux2[i]+female_transport_number_reformed_jux3[i]+female_transport_number_reformed_jux4[i]+female_transport_number_reformed_jux5[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
# Female_later=axarr[2,1].bar(np.arange(len(segment_transport))+0.5*bar_width,female_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50=axarr[2,1].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,female_transport_number_reformed_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female, "pregnancy"')
# Female_jux_nhe50=axarr[2,1].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,[female_transport_number_reformed_jux1_nhe50[i]+female_transport_number_reformed_jux2_nhe50[i]+female_transport_number_reformed_jux3_nhe50[i]+female_transport_number_reformed_jux4_nhe50[i]+female_transport_number_reformed_jux5_nhe50[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
# Female_later_nhe50=axarr[2,1].bar(np.arange(len(segment_transport))+1.5*bar_width,female_transport_number_reformed_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
# female_transport_number_reformed[6] = female_transport_number[7]+female_transport_number[8]+female_transport_number[9]+0.12
...
# male_sup=axarr[3,0].bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,male_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male, SNGFR inc')
# male_jux=axarr[3,0].bar(np.arange(len(segment_transport[:6]))-0.5*bar_width,[male_transport_number_reformed_jux1[i]+male_transport_number_reformed_jux2[i]+male_transport_number_reformed_jux3[i]+male_transport_number_reformed_jux4[i]+male_transport_number_reformed_jux5[i] for i in range(len(male_transport_number_reformed_sup))],bar_width,bottom=male_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
# male_later=axarr[3,0].bar(np.arange(len(segment_transport))-0.5*bar_width,male_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

# Female_sup=axarr[3,0].bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,female_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female, SNGFR inc')
# Female_jux=axarr[3,0].bar(np.arange(len(segment_transport[:6]))+0.5*bar_width,[female_transport_number_reformed_jux1[i]+female_transport_number_reformed_jux2[i]+female_transport_number_reformed_jux3[i]+female_transport_number_reformed_jux4[i]+female_transport_number_reformed_jux5[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
# Female_later=axarr[3,0].bar(np.arange(len(segment_transport))+0.5*bar_width,female_transport_number_reformed,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50=axarr[3,0].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,female_transport_number_reformed_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female, "pregnancy"')
# Female_jux_nhe50=axarr[3,0].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,[female_transport_number_reformed_jux1_nhe50[i]+female_transport_number_reformed_jux2_nhe50[i]+female_transport_number_reformed_jux3_nhe50[i]+female_transport_number_reformed_jux4_nhe50[i]+female_transport_number_reformed_jux5_nhe50[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
# Female_later_nhe50=axarr[3,0].bar(np.arange(len(segment_transport))+1.5*bar_width,female_transport_number_reformed_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
Female_sup_nhe50=axarr[1,1].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,female_transport_number_reformed_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female, "pregnancy"')
for i in range(len(segment_transport[:6])):
    if female_transport_number_reformed_sup_nhe50[i]>0 and female_transport_number_reformed_jux1_nhe50[i]+female_transport_number_reformed_jux2_nhe50[i]+female_transport_number_reformed_jux3_nhe50[i]+female_transport_number_reformed_jux4_nhe50[i]+female_transport_number_reformed_jux5_nhe50[i]<0:
        female_transport_number_reformed_sup_nhe50[i] = 0
Female_jux_nhe50=axarr[1,1].bar(np.arange(len(segment_transport[:6]))+1.5*bar_width,[female_transport_number_reformed_jux1_nhe50[i]+female_transport_number_reformed_jux2_nhe50[i]+female_transport_number_reformed_jux3_nhe50[i]+female_transport_number_reformed_jux4_nhe50[i]+female_transport_number_reformed_jux5_nhe50[i] for i in range(len(female_transport_number_reformed_sup))],bar_width,bottom=female_transport_number_reformed_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='White')
Female_later_nhe50=axarr[1,1].bar(np.arange(len(segment_transport))+1.5*bar_width,female_transport_number_reformed_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
axarr[1,1].tick_params(axis='both',labelsize=30)
#ax.set_xlabel('Segment',fontsize=20)
axarr[1,1].set_ylabel('Volume transport (L/Day)',fontsize=30)
...
axarr[0,0].text(-1,axarr[0,0].get_ylim()[1],'E',size=40,weight='bold')
axarr[0,1].text(-1,axarr[0,1].get_ylim()[1],'F',size=40,weight='bold')
axarr[1,0].text(-1,axarr[1,0].get_ylim()[1],'G',size=40,weight='bold')
axarr[1,1].text(-1,axarr[1,1].get_ylim()[1],'H',size=40,weight='bold')
...
#plt.show()
plt.savefig('transport_pregnant',bbox_inches='tight')