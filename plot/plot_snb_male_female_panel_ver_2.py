...
female_nhe50_file = './female_SNB70' # nhe50/nkcc70
female_nhe80_file = './female_SNB100' # nhe80/nkcc100

male_normal_file = './male_normal_check'
male_nhe50_file = './male_SNB70'
male_nhe80_file = './male_SNB100'
...
male_sup=axarr[0].bar(np.arange(len(segment[:6])),male_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male Baseline')
male_jux=axarr[0].bar(np.arange(len(segment[:6])),[male_delivery_jux1[i]+male_delivery_jux2[i]+male_delivery_jux3[i]+male_delivery_jux4[i]+male_delivery_jux5[i] for i in range(len(male_delivery_sup))],bar_width,bottom=male_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later=axarr[0].bar(np.arange(len(segment)),male_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

male_sup_nhe50=axarr[0].bar(np.arange(len(segment[:6]))+bar_width,male_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='Male 70% SNB')
male_jux_nhe50=axarr[0].bar(np.arange(len(segment[:6]))+bar_width,[male_delivery_jux1_nhe50[i]+male_delivery_jux2_nhe50[i]+male_delivery_jux3_nhe50[i]+male_delivery_jux4_nhe50[i]+male_delivery_jux5_nhe50[i] for i in range(len(male_delivery_sup_nhe50))],bar_width,bottom=male_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later_nhe50=axarr[0].bar(np.arange(len(segment))+bar_width,male_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')

male_sup_nhe80=axarr[0].bar(np.arange(len(segment[:6]))+2*bar_width,male_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise',label='Male 100% SNB')
male_jux_nhe80=axarr[0].bar(np.arange(len(segment[:6]))+2*bar_width,[male_delivery_jux1_nhe80[i]+male_delivery_jux2_nhe80[i]+male_delivery_jux3_nhe80[i]+male_delivery_jux4_nhe80[i]+male_delivery_jux5_nhe80[i] for i in range(len(male_delivery_sup_nhe80))],bar_width,bottom=male_delivery_sup_nhe80,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later_nhe80=axarr[0].bar(np.arange(len(segment))+2*bar_width,male_delivery_number_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise')

Female_sup=axarr[0].bar(np.arange(len(segment[:6]))+3*bar_width,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')
Female_jux=axarr[0].bar(np.arange(len(segment[:6]))+3*bar_width,[female_delivery_jux1[i]+female_delivery_jux2[i]+female_delivery_jux3[i]+female_delivery_jux4[i]+female_delivery_jux5[i] for i in range(len(female_delivery_sup))],bar_width,bottom=female_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later=axarr[0].bar(np.arange(len(segment))+3*bar_width,female_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

Female_sup_nhe50=axarr[0].bar(np.arange(len(segment[:6]))+4*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
Female_jux_nhe50=axarr[0].bar(np.arange(len(segment[:6]))+4*bar_width,[female_delivery_jux1_nhe50[i]+female_delivery_jux2_nhe50[i]+female_delivery_jux3_nhe50[i]+female_delivery_jux4_nhe50[i]+female_delivery_jux5_nhe50[i] for i in range(len(female_delivery_sup_nhe50))],bar_width,bottom=female_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later_nhe50=axarr[0].bar(np.arange(len(segment))+4*bar_width,female_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')

Female_sup_nhe80=axarr[0].bar(np.arange(len(segment[:6]))+5*bar_width,female_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink')
Female_jux_nhe80=axarr[0].bar(np.arange(len(segment[:6]))+5*bar_width,[female_delivery_jux1_nhe80[i]+female_delivery_jux2_nhe80[i]+female_delivery_jux3_nhe80[i]+female_delivery_jux4_nhe80[i]+female_delivery_jux5_nhe80[i] for i in range(len(female_delivery_sup_nhe80))],bar_width,bottom=female_delivery_sup_nhe80,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later_nhe80=axarr[0].bar(np.arange(len(segment))+5*bar_width,female_delivery_number_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink')

print(male_delivery_number[-1])
print(male_delivery_number_nhe50[-1])
print(male_delivery_number_nhe80[-1])
print(female_delivery_number[-1])
print(female_delivery_number_nhe50[-1])
print(female_delivery_number_nhe80[-1])
axarr[0].set_xticks(np.arange(len(segment))+2.5*bar_width)
axarr[0].set_xticklabels(segment,fontsize=40)
...
#axarr[0].set_title('Sequential nephron blockade',fontsize=50)
axarr[0].legend(fontsize=40,markerscale=40)

# bar_width_ins = bar_width
# axins = inset_axes(axarr[0],width=6.5,height=3.5,loc=7)
...
# male_sup_nhe50_inset=axins.bar(np.arange(len(segment[:6]))+bar_width_ins,male_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='50% SNB')
...
# male_sup_nhe80_inset=axins.bar(np.arange(len(segment[:6]))+2*bar_width_ins,male_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise',label='100% SNB')
# male_jux_nhe80_inset=axins.bar(np.arange(len(segment[:6]))+2*bar_width_ins,[male_delivery_jux1_nhe80[i]+male_delivery_jux2_nhe80[i]+male_delivery_jux3_nhe80[i]+male_delivery_jux4_nhe80[i]+male_delivery_jux5_nhe80[i] for i in range(len(male_delivery_sup_nhe80))],bar_width,bottom=male_delivery_sup_nhe80,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later_nhe80_inset=axins.bar(np.arange(len(segment))+2*bar_width_ins,male_delivery_number_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise')

# Female_sup_inset=axins.bar(np.arange(len(segment[:6]))+3*bar_width_ins,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Baseline')
# Female_jux_inset=axins.bar(np.arange(len(segment[:6]))+3*bar_width_ins,[female_delivery_jux1[i]+female_delivery_jux2[i]+female_delivery_jux3[i]+female_delivery_jux4[i]+female_delivery_jux5[i] for i in range(len(female_delivery_sup))],bar_width,bottom=female_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_inset=axins.bar(np.arange(len(segment))+3*bar_width_ins,female_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50_inset=axins.bar(np.arange(len(segment[:6]))+4*bar_width_ins,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='50% SNB')
# Female_jux_nhe50_inset=axins.bar(np.arange(len(segment[:6]))+4*bar_width_ins,[female_delivery_jux1_nhe50[i]+female_delivery_jux2_nhe50[i]+female_delivery_jux3_nhe50[i]+female_delivery_jux4_nhe50[i]+female_delivery_jux5_nhe50[i] for i in range(len(female_delivery_sup_nhe50))],bar_width,bottom=female_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_nhe50_inset=axins.bar(np.arange(len(segment))+4*bar_width_ins,female_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')

# Female_sup_nhe80_inset=axins.bar(np.arange(len(segment[:6]))+5*bar_width_ins,female_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink',label='100% SNB')
# Female_jux_nhe80_inset=axins.bar(np.arange(len(segment[:6]))+5*bar_width_ins,[female_delivery_jux1_nhe80[i]+female_delivery_jux2_nhe80[i]+female_delivery_jux3_nhe80[i]+female_delivery_jux4_nhe80[i]+female_delivery_jux5_nhe80[i] for i in range(len(female_delivery_sup_nhe80))],bar_width,bottom=female_delivery_sup_nhe80,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_nhe80_inset=axins.bar(np.arange(len(segment))+5*bar_width_ins,female_delivery_number_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink')

# axins.set_xticks(np.arange(len(segment))+2.5*bar_width_ins)
# axins.set_xticklabels(segment,fontsize=40)
# axins.set_xlim(5-1.5*bar_width_ins,6+6*bar_width_ins)
# axins.set_ylim(0,55)
...
male_sup=axarr[1].bar(np.arange(len(segment[:6])),male_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')
male_jux=axarr[1].bar(np.arange(len(segment[:6])),[male_delivery_jux1[i]+male_delivery_jux2[i]+male_delivery_jux3[i]+male_delivery_jux4[i]+male_delivery_jux5[i] for i in range(len(male_delivery_sup))],bar_width,bottom=male_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later=axarr[1].bar(np.arange(len(segment)),male_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

male_sup_nhe50=axarr[1].bar(np.arange(len(segment[:6]))+bar_width,male_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')
male_jux_nhe50=axarr[1].bar(np.arange(len(segment[:6]))+bar_width,[male_delivery_jux1_nhe50[i]+male_delivery_jux2_nhe50[i]+male_delivery_jux3_nhe50[i]+male_delivery_jux4_nhe50[i]+male_delivery_jux5_nhe50[i] for i in range(len(male_delivery_sup_nhe50))],bar_width,bottom=male_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later_nhe50=axarr[1].bar(np.arange(len(segment))+bar_width,male_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')

male_sup_nhe80=axarr[1].bar(np.arange(len(segment[:6]))+2*bar_width,male_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise')
male_jux_nhe80=axarr[1].bar(np.arange(len(segment[:6]))+2*bar_width,[male_delivery_jux1_nhe80[i]+male_delivery_jux2_nhe80[i]+male_delivery_jux3_nhe80[i]+male_delivery_jux4_nhe80[i]+male_delivery_jux5_nhe80[i] for i in range(len(male_delivery_sup_nhe80))],bar_width,bottom=male_delivery_sup_nhe80,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later_nhe80=axarr[1].bar(np.arange(len(segment))+2*bar_width,male_delivery_number_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise')

Female_sup=axarr[1].bar(np.arange(len(segment[:6]))+3*bar_width,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female Baseline')
Female_jux=axarr[1].bar(np.arange(len(segment[:6]))+3*bar_width,[female_delivery_jux1[i]+female_delivery_jux2[i]+female_delivery_jux3[i]+female_delivery_jux4[i]+female_delivery_jux5[i] for i in range(len(female_delivery_sup))],bar_width,bottom=female_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later=axarr[1].bar(np.arange(len(segment))+3*bar_width,female_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

Female_sup_nhe50=axarr[1].bar(np.arange(len(segment[:6]))+4*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female 70% SNB')
Female_jux_nhe50=axarr[1].bar(np.arange(len(segment[:6]))+4*bar_width,[female_delivery_jux1_nhe50[i]+female_delivery_jux2_nhe50[i]+female_delivery_jux3_nhe50[i]+female_delivery_jux4_nhe50[i]+female_delivery_jux5_nhe50[i] for i in range(len(female_delivery_sup_nhe50))],bar_width,bottom=female_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later_nhe50=axarr[1].bar(np.arange(len(segment))+4*bar_width,female_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')

Female_sup_nhe80=axarr[1].bar(np.arange(len(segment[:6]))+5*bar_width,female_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink',label='Female 100% SNB')
Female_jux_nhe80=axarr[1].bar(np.arange(len(segment[:6]))+5*bar_width,[female_delivery_jux1_nhe80[i]+female_delivery_jux2_nhe80[i]+female_delivery_jux3_nhe80[i]+female_delivery_jux4_nhe80[i]+female_delivery_jux5_nhe80[i] for i in range(len(female_delivery_sup_nhe80))],bar_width,bottom=female_delivery_sup_nhe80,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later_nhe80=axarr[1].bar(np.arange(len(segment))+5*bar_width,female_delivery_number_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink')

axarr[1].set_xticks(np.arange(len(segment))+2.5*bar_width)
axarr[1].set_xticklabels(segment,fontsize=40)
...
male_sup=axarr[2].bar(np.arange(len(segment[:6])),male_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male')
male_jux=axarr[2].bar(np.arange(len(segment[:6])),[male_delivery_jux1[i]+male_delivery_jux2[i]+male_delivery_jux3[i]+male_delivery_jux4[i]+male_delivery_jux5[i] for i in range(len(male_delivery_sup))],bar_width,bottom=male_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later=axarr[2].bar(np.arange(len(segment)),male_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

male_sup_nhe50=axarr[2].bar(np.arange(len(segment[:6]))+bar_width,male_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='Male')
male_jux_nhe50=axarr[2].bar(np.arange(len(segment[:6]))+bar_width,[male_delivery_jux1_nhe50[i]+male_delivery_jux2_nhe50[i]+male_delivery_jux3_nhe50[i]+male_delivery_jux4_nhe50[i]+male_delivery_jux5_nhe50[i] for i in range(len(male_delivery_sup_nhe50))],bar_width,bottom=male_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later_nhe50=axarr[2].bar(np.arange(len(segment))+bar_width,male_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')

male_sup_nhe80=axarr[2].bar(np.arange(len(segment[:6]))+2*bar_width,male_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise',label='Male')
male_jux_nhe80=axarr[2].bar(np.arange(len(segment[:6]))+2*bar_width,[male_delivery_jux1_nhe80[i]+male_delivery_jux2_nhe80[i]+male_delivery_jux3_nhe80[i]+male_delivery_jux4_nhe80[i]+male_delivery_jux5_nhe80[i] for i in range(len(male_delivery_sup_nhe80))],bar_width,bottom=male_delivery_sup_nhe80,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later_nhe80=axarr[2].bar(np.arange(len(segment))+2*bar_width,male_delivery_number_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise')

Female_sup=axarr[2].bar(np.arange(len(segment[:6]))+3*bar_width,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female')
Female_jux=axarr[2].bar(np.arange(len(segment[:6]))+3*bar_width,[female_delivery_jux1[i]+female_delivery_jux2[i]+female_delivery_jux3[i]+female_delivery_jux4[i]+female_delivery_jux5[i] for i in range(len(female_delivery_sup))],bar_width,bottom=female_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white',label='Juxtamedullary')
Female_later=axarr[2].bar(np.arange(len(segment))+3*bar_width,female_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

Female_sup_nhe50=axarr[2].bar(np.arange(len(segment[:6]))+4*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female')
Female_jux_nhe50=axarr[2].bar(np.arange(len(segment[:6]))+4*bar_width,[female_delivery_jux1_nhe50[i]+female_delivery_jux2_nhe50[i]+female_delivery_jux3_nhe50[i]+female_delivery_jux4_nhe50[i]+female_delivery_jux5_nhe50[i] for i in range(len(female_delivery_sup_nhe50))],bar_width,bottom=female_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white',label='Juxtamedullary')
Female_later_nhe50=axarr[2].bar(np.arange(len(segment))+4*bar_width,female_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')

Female_sup_nhe80=axarr[2].bar(np.arange(len(segment[:6]))+5*bar_width,female_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink',label='Female')
Female_jux_nhe80=axarr[2].bar(np.arange(len(segment[:6]))+5*bar_width,[female_delivery_jux1_nhe80[i]+female_delivery_jux2_nhe80[i]+female_delivery_jux3_nhe80[i]+female_delivery_jux4_nhe80[i]+female_delivery_jux5_nhe80[i] for i in range(len(female_delivery_sup_nhe80))],bar_width,bottom=female_delivery_sup_nhe80,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white',label='Juxtamedullary')
Female_later_nhe80=axarr[2].bar(np.arange(len(segment))+5*bar_width,female_delivery_number_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink')

axarr[2].set_xticks(np.arange(len(segment))+2.5*bar_width)
axarr[2].set_xticklabels(segment,fontsize=40)
axarr[2].tick_params(axis='both',labelsize=40)
axarr[2].set_ylim(0,1.9)
#ax.set_xlabel('Segment',fontsize=20)
...
male_sup=axarr[3].bar(np.arange(len(segment[:6])),male_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male')
male_jux=axarr[3].bar(np.arange(len(segment[:6])),[male_delivery_jux1[i]+male_delivery_jux2[i]+male_delivery_jux3[i]+male_delivery_jux4[i]+male_delivery_jux5[i] for i in range(len(male_delivery_sup))],bar_width,bottom=male_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later=axarr[3].bar(np.arange(len(segment)),male_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

male_sup_nhe50=axarr[3].bar(np.arange(len(segment[:6]))+bar_width,male_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='Male')
male_jux_nhe50=axarr[3].bar(np.arange(len(segment[:6]))+bar_width,[male_delivery_jux1_nhe50[i]+male_delivery_jux2_nhe50[i]+male_delivery_jux3_nhe50[i]+male_delivery_jux4_nhe50[i]+male_delivery_jux5_nhe50[i] for i in range(len(male_delivery_sup_nhe50))],bar_width,bottom=male_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later_nhe50=axarr[3].bar(np.arange(len(segment))+bar_width,male_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue')

male_sup_nhe80=axarr[3].bar(np.arange(len(segment[:6]))+2*bar_width,male_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise',label='Male')
male_jux_nhe80=axarr[3].bar(np.arange(len(segment[:6]))+2*bar_width,[male_delivery_jux1_nhe80[i]+male_delivery_jux2_nhe80[i]+male_delivery_jux3_nhe80[i]+male_delivery_jux4_nhe80[i]+male_delivery_jux5_nhe80[i] for i in range(len(male_delivery_sup_nhe80))],bar_width,bottom=male_delivery_sup_nhe80,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later_nhe80=axarr[3].bar(np.arange(len(segment))+2*bar_width,male_delivery_number_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise')

Female_sup=axarr[3].bar(np.arange(len(segment[:6]))+3*bar_width,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female')
Female_jux=axarr[3].bar(np.arange(len(segment[:6]))+3*bar_width,[female_delivery_jux1[i]+female_delivery_jux2[i]+female_delivery_jux3[i]+female_delivery_jux4[i]+female_delivery_jux5[i] for i in range(len(female_delivery_sup))],bar_width,bottom=female_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white',label='Juxtamedullary')
Female_later=axarr[3].bar(np.arange(len(segment))+3*bar_width,female_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

Female_sup_nhe50=axarr[3].bar(np.arange(len(segment[:6]))+4*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female')
Female_jux_nhe50=axarr[3].bar(np.arange(len(segment[:6]))+4*bar_width,[female_delivery_jux1_nhe50[i]+female_delivery_jux2_nhe50[i]+female_delivery_jux3_nhe50[i]+female_delivery_jux4_nhe50[i]+female_delivery_jux5_nhe50[i] for i in range(len(female_delivery_sup_nhe50))],bar_width,bottom=female_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white',label='Juxtamedullary')
Female_later_nhe50=axarr[3].bar(np.arange(len(segment))+4*bar_width,female_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')

Female_sup_nhe80=axarr[3].bar(np.arange(len(segment[:6]))+5*bar_width,female_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink',label='Female')
Female_jux_nhe80=axarr[3].bar(np.arange(len(segment[:6]))+5*bar_width,[female_delivery_jux1_nhe80[i]+female_delivery_jux2_nhe80[i]+female_delivery_jux3_nhe80[i]+female_delivery_jux4_nhe80[i]+female_delivery_jux5_nhe80[i] for i in range(len(female_delivery_sup_nhe80))],bar_width,bottom=female_delivery_sup_nhe80,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white',label='Juxtamedullary')
Female_later_nhe80=axarr[3].bar(np.arange(len(segment))+5*bar_width,female_delivery_number_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink')

axarr[3].set_xticks(np.arange(len(segment))+2.5*bar_width)
axarr[3].set_xticklabels(segment,fontsize=40)
...
# bar_width_ins = bar_width
# axins = inset_axes(axarr[3],width=6.5,height=3.5,loc=7)
...
# male_sup_nhe80_inset=axins.bar(np.arange(len(segment[:6]))+2*bar_width_ins,male_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise',label='80% NHE3 inhib')
# male_jux_nhe80_inset=axins.bar(np.arange(len(segment[:6]))+2*bar_width_ins,[male_delivery_jux1_nhe80[i]+male_delivery_jux2_nhe80[i]+male_delivery_jux3_nhe80[i]+male_delivery_jux4_nhe80[i]+male_delivery_jux5_nhe80[i] for i in range(len(male_delivery_sup_nhe80))],bar_width,bottom=male_delivery_sup_nhe80,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later_nhe80_inset=axins.bar(np.arange(len(segment))+2*bar_width_ins,male_delivery_number_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise')
...
# Female_sup_nhe50_inset=axins.bar(np.arange(len(segment[:6]))+4*bar_width_ins,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='50% NHE3 inhib')
# Female_jux_nhe50_inset=axins.bar(np.arange(len(segment[:6]))+4*bar_width_ins,[female_delivery_jux1_nhe50[i]+female_delivery_jux2_nhe50[i]+female_delivery_jux3_nhe50[i]+female_delivery_jux4_nhe50[i]+female_delivery_jux5_nhe50[i] for i in range(len(female_delivery_sup_nhe50))],bar_width,bottom=female_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_nhe50_inset=axins.bar(np.arange(len(segment))+4*bar_width_ins,female_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')

# Female_sup_nhe80_inset=axins.bar(np.arange(len(segment[:6]))+5*bar_width_ins,female_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink',label='80% NHE3 inhib')
# Female_jux_nhe80_inset=axins.bar(np.arange(len(segment[:6]))+5*bar_width_ins,[female_delivery_jux1_nhe80[i]+female_delivery_jux2_nhe80[i]+female_delivery_jux3_nhe80[i]+female_delivery_jux4_nhe80[i]+female_delivery_jux5_nhe80[i] for i in range(len(female_delivery_sup_nhe80))],bar_width,bottom=female_delivery_sup_nhe80,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_nhe80_inset=axins.bar(np.arange(len(segment))+5*bar_width_ins,female_delivery_number_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink')
...
axarr[0].text(-0.8,axarr[0].get_ylim()[1],'A',size=40,weight='bold')
axarr[1].text(-0.8,axarr[1].get_ylim()[1],'B',size=40,weight='bold')
axarr[2].text(-0.8,axarr[2].get_ylim()[1],'C',size=40,weight='bold')
axarr[3].text(-0.8,axarr[3].get_ylim()[1],'D',size=40,weight='bold')

plt.savefig('delivery_comp_panel_SNB_female_male',bbox_inches='tight')