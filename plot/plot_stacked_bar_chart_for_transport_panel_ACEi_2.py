...
male_sup=axarr[0,0].bar(np.arange(len(segment_transport[:6])),male_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male with ACEi')
...
Female_sup=axarr[0,0].bar(np.arange(len(segment_transport[:6]))+bar_width,female_transport_number_reformed_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female with ACEi')
...
#plt.show()
plt.savefig('transport_ACEi_2',bbox_inches='tight')