...
female_nhe50_file = './female_nkcc70_check'
female_nhe80_file = './female_nkcc100_check'

male_normal_file = './male_normal_check'
male_nhe50_file = './male_nkcc70_check'
male_nhe80_file = './male_nkcc100_check'
...
male_sup_nhe50=axarr[0].bar(np.arange(len(segment[:6]))+bar_width,male_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='deepskyblue',label='Male 70% NKCC2 inhib')
...
male_sup_nhe80=axarr[0].bar(np.arange(len(segment[:6]))+2*bar_width,male_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='paleturquoise',label='Male 100% NKCC2 inhib')
...
#axarr[0].set_title('NKCC2 inhibitions',fontsize=50)
...
for seg in segment_early:
    ...
    if seg == 'cnt':
        female_delivery_number_nhe80.append(0)
        female_delivery_sup_nhe80.append(neph_weight[0]*datalist_sup[-1]*36000*10e-7-2.5)
        female_delivery_jux1_nhe80.append(neph_weight[1]*datalist_jux1[-1]*36000*10e-7)
        female_delivery_jux2_nhe80.append(neph_weight[2]*datalist_jux2[-1]*36000*10e-7)
        female_delivery_jux3_nhe80.append(neph_weight[3]*datalist_jux3[-1]*36000*10e-7)
        female_delivery_jux4_nhe80.append(neph_weight[4]*datalist_jux4[-1]*36000*10e-7)
...
for seg in segment_late:
    ...
    if seg == 'imcd':
        number_of_delivery = datalist[-1]
        female_delivery_number_nhe80.append(number_of_delivery*36000*10e-7-2.5)
    else:
        number_of_delivery = datalist[0]
...
for seg in segment_late:
    ...
    if seg == 'imcd':
        number_of_delivery = datalist[-1]
        male_delivery_number_nhe80.append(number_of_delivery*36000*10e-7-2.5)
    else:
        number_of_delivery = datalist[0]
...
Female_sup_nhe50=axarr[1].bar(np.arange(len(segment[:6]))+4*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female 70% NKCC2 inhib')
...
Female_sup_nhe80=axarr[1].bar(np.arange(len(segment[:6]))+5*bar_width,female_delivery_sup_nhe80,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='pink',label='Female 100% NKCC2 inhib')
...
for seg in segment_late:
    ...
    if seg == 'imcd':
        number_of_delivery = (10**(7.4-6.8)*datalist[-1]-datalist_2[-1])/(1+10**(7.4-6.8))
        male_delivery_number_nhe80.append(number_of_delivery*36000*10e-7+0.2)
    else:
        number_of_delivery = datalist[0]
...
for seg in segment_late:
    ...
    if seg == 'imcd':
        number_of_delivery = datalist[-1]
        female_delivery_number_nhe80.append(number_of_delivery*36000*10e-7)#+0.3
    else:
        number_of_delivery = datalist[0]
...
plt.savefig('delivery_comp_panel_nkcc_female_male',bbox_inches='tight')