...
Female_sup=axarr[0,0].bar(np.arange(len(segment[:6]))+bar_width,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female baseline')
...
#ax.set_xlabel('Segment',fontsize=20)
axarr[1,1].set_ylabel('HCO$_3^-$ delivery (mol/Day)',fontsize=30)
...
#plt.show()
plt.savefig('delivery_baseline',bbox_inches='tight')