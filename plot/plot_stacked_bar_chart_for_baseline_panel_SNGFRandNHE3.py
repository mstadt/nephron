...
male_sup=axarr[0,0].bar(np.arange(len(segment[:6]))-0.5*bar_width,male_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male')
male_jux=axarr[0,0].bar(np.arange(len(segment[:6]))-0.5*bar_width,[male_delivery_jux1[i]+male_delivery_jux2[i]+male_delivery_jux3[i]+male_delivery_jux4[i]+male_delivery_jux5[i] for i in range(len(male_delivery_sup))],bar_width,bottom=male_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later=axarr[0,0].bar(np.arange(len(segment))-0.5*bar_width,male_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

Female_sup=axarr[0,0].bar(np.arange(len(segment[:6]))+0.5*bar_width,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Non-adaptive female')
Female_jux=axarr[0,0].bar(np.arange(len(segment[:6]))+0.5*bar_width,[female_delivery_jux1[i]+female_delivery_jux2[i]+female_delivery_jux3[i]+female_delivery_jux4[i]+female_delivery_jux5[i] for i in range(len(female_delivery_sup))],bar_width,bottom=female_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later=axarr[0,0].bar(np.arange(len(segment))+0.5*bar_width,female_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

Female_sup_nhe50=axarr[0,0].bar(np.arange(len(segment[:6]))+1.5*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Adaptive female')
Female_jux_nhe50=axarr[0,0].bar(np.arange(len(segment[:6]))+1.5*bar_width,[female_delivery_jux1_nhe50[i]+female_delivery_jux2_nhe50[i]+female_delivery_jux3_nhe50[i]+female_delivery_jux4_nhe50[i]+female_delivery_jux5_nhe50[i] for i in range(len(female_delivery_sup_nhe50))],bar_width,bottom=female_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later_nhe50=axarr[0,0].bar(np.arange(len(segment))+1.5*bar_width,female_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
male_sup=axarr[0,1].bar(np.arange(len(segment[:6]))-0.5*bar_width,male_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male, SNGFR inc')
male_jux=axarr[0,1].bar(np.arange(len(segment[:6]))-0.5*bar_width,[male_delivery_jux1[i]+male_delivery_jux2[i]+male_delivery_jux3[i]+male_delivery_jux4[i]+male_delivery_jux5[i] for i in range(len(male_delivery_sup))],bar_width,bottom=male_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later=axarr[0,1].bar(np.arange(len(segment))-0.5*bar_width,male_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

Female_sup=axarr[0,1].bar(np.arange(len(segment[:6]))+0.5*bar_width,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female, SNGFR inc')
Female_jux=axarr[0,1].bar(np.arange(len(segment[:6]))+0.5*bar_width,[female_delivery_jux1[i]+female_delivery_jux2[i]+female_delivery_jux3[i]+female_delivery_jux4[i]+female_delivery_jux5[i] for i in range(len(female_delivery_sup))],bar_width,bottom=female_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later=axarr[0,1].bar(np.arange(len(segment))+0.5*bar_width,female_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

Female_sup_nhe50=axarr[0,1].bar(np.arange(len(segment[:6]))+1.5*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female, "pregnancy"')
Female_jux_nhe50=axarr[0,1].bar(np.arange(len(segment[:6]))+1.5*bar_width,[female_delivery_jux1_nhe50[i]+female_delivery_jux2_nhe50[i]+female_delivery_jux3_nhe50[i]+female_delivery_jux4_nhe50[i]+female_delivery_jux5_nhe50[i] for i in range(len(female_delivery_sup_nhe50))],bar_width,bottom=female_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later_nhe50=axarr[0,1].bar(np.arange(len(segment))+1.5*bar_width,female_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
male_sup=axarr[1,0].bar(np.arange(len(segment[:6]))-0.5*bar_width,male_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male, SNGFR inc')
male_jux=axarr[1,0].bar(np.arange(len(segment[:6]))-0.5*bar_width,[male_delivery_jux1[i]+male_delivery_jux2[i]+male_delivery_jux3[i]+male_delivery_jux4[i]+male_delivery_jux5[i] for i in range(len(male_delivery_sup))],bar_width,bottom=male_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
male_later=axarr[1,0].bar(np.arange(len(segment))-0.5*bar_width,male_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

Female_sup=axarr[1,0].bar(np.arange(len(segment[:6]))+0.5*bar_width,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female, SNGFR inc')
Female_jux=axarr[1,0].bar(np.arange(len(segment[:6]))+0.5*bar_width,[female_delivery_jux1[i]+female_delivery_jux2[i]+female_delivery_jux3[i]+female_delivery_jux4[i]+female_delivery_jux5[i] for i in range(len(female_delivery_sup))],bar_width,bottom=female_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later=axarr[1,0].bar(np.arange(len(segment))+0.5*bar_width,female_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

Female_sup_nhe50=axarr[1,0].bar(np.arange(len(segment[:6]))+1.5*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female, "pregnancy"')
Female_jux_nhe50=axarr[1,0].bar(np.arange(len(segment[:6]))+1.5*bar_width,[female_delivery_jux1_nhe50[i]+female_delivery_jux2_nhe50[i]+female_delivery_jux3_nhe50[i]+female_delivery_jux4_nhe50[i]+female_delivery_jux5_nhe50[i] for i in range(len(female_delivery_sup_nhe50))],bar_width,bottom=female_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
Female_later_nhe50=axarr[1,0].bar(np.arange(len(segment))+1.5*bar_width,female_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
# male_sup=axarr[1,1].bar(np.arange(len(segment[:6]))-0.5*bar_width,male_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male, SNGFR inc')
# male_jux=axarr[1,1].bar(np.arange(len(segment[:6]))-0.5*bar_width,[male_delivery_jux1[i]+male_delivery_jux2[i]+male_delivery_jux3[i]+male_delivery_jux4[i]+male_delivery_jux5[i] for i in range(len(male_delivery_sup))],bar_width,bottom=male_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later=axarr[1,1].bar(np.arange(len(segment))-0.5*bar_width,male_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

# Female_sup=axarr[1,1].bar(np.arange(len(segment[:6]))+0.5*bar_width,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female, SNGFR inc')
# Female_jux=axarr[1,1].bar(np.arange(len(segment[:6]))+0.5*bar_width,[female_delivery_jux1[i]+female_delivery_jux2[i]+female_delivery_jux3[i]+female_delivery_jux4[i]+female_delivery_jux5[i] for i in range(len(female_delivery_sup))],bar_width,bottom=female_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later=axarr[1,1].bar(np.arange(len(segment))+0.5*bar_width,female_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50=axarr[1,1].bar(np.arange(len(segment[:6]))+1.5*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female, "pregnancy"')
# Female_jux_nhe50=axarr[1,1].bar(np.arange(len(segment[:6]))+1.5*bar_width,[female_delivery_jux1_nhe50[i]+female_delivery_jux2_nhe50[i]+female_delivery_jux3_nhe50[i]+female_delivery_jux4_nhe50[i]+female_delivery_jux5_nhe50[i] for i in range(len(female_delivery_sup_nhe50))],bar_width,bottom=female_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_nhe50=axarr[1,1].bar(np.arange(len(segment))+1.5*bar_width,female_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
# male_sup=axarr[2,0].bar(np.arange(len(segment[:6]))-0.5*bar_width,male_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male, SNGFR inc')
# male_jux=axarr[2,0].bar(np.arange(len(segment[:6]))-0.5*bar_width,[male_delivery_jux1[i]+male_delivery_jux2[i]+male_delivery_jux3[i]+male_delivery_jux4[i]+male_delivery_jux5[i] for i in range(len(male_delivery_sup))],bar_width,bottom=male_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later=axarr[2,0].bar(np.arange(len(segment))-0.5*bar_width,male_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

# Female_sup=axarr[2,0].bar(np.arange(len(segment[:6]))+0.5*bar_width,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female, SNGFR inc')
# Female_jux=axarr[2,0].bar(np.arange(len(segment[:6]))+0.5*bar_width,[female_delivery_jux1[i]+female_delivery_jux2[i]+female_delivery_jux3[i]+female_delivery_jux4[i]+female_delivery_jux5[i] for i in range(len(female_delivery_sup))],bar_width,bottom=female_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later=axarr[2,0].bar(np.arange(len(segment))+0.5*bar_width,female_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50=axarr[2,0].bar(np.arange(len(segment[:6]))+1.5*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female, "pregnancy"')
# Female_jux_nhe50=axarr[2,0].bar(np.arange(len(segment[:6]))+1.5*bar_width,[female_delivery_jux1_nhe50[i]+female_delivery_jux2_nhe50[i]+female_delivery_jux3_nhe50[i]+female_delivery_jux4_nhe50[i]+female_delivery_jux5_nhe50[i] for i in range(len(female_delivery_sup_nhe50))],bar_width,bottom=female_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_nhe50=axarr[2,0].bar(np.arange(len(segment))+1.5*bar_width,female_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
# male_sup=axarr[2,1].bar(np.arange(len(segment[:6]))-0.5*bar_width,male_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male, SNGFR inc')
# male_jux=axarr[2,1].bar(np.arange(len(segment[:6]))-0.5*bar_width,[male_delivery_jux1[i]+male_delivery_jux2[i]+male_delivery_jux3[i]+male_delivery_jux4[i]+male_delivery_jux5[i] for i in range(len(male_delivery_sup))],bar_width,bottom=male_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later=axarr[2,1].bar(np.arange(len(segment))-0.5*bar_width,male_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

# Female_sup=axarr[2,1].bar(np.arange(len(segment[:6]))+0.5*bar_width,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female, SNGFR inc')
# Female_jux=axarr[2,1].bar(np.arange(len(segment[:6]))+0.5*bar_width,[female_delivery_jux1[i]+female_delivery_jux2[i]+female_delivery_jux3[i]+female_delivery_jux4[i]+female_delivery_jux5[i] for i in range(len(female_delivery_sup))],bar_width,bottom=female_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later=axarr[2,1].bar(np.arange(len(segment))+0.5*bar_width,female_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50=axarr[2,1].bar(np.arange(len(segment[:6]))+1.5*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female, "pregnancy"')
# Female_jux_nhe50=axarr[2,1].bar(np.arange(len(segment[:6]))+1.5*bar_width,[female_delivery_jux1_nhe50[i]+female_delivery_jux2_nhe50[i]+female_delivery_jux3_nhe50[i]+female_delivery_jux4_nhe50[i]+female_delivery_jux5_nhe50[i] for i in range(len(female_delivery_sup_nhe50))],bar_width,bottom=female_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_nhe50=axarr[2,1].bar(np.arange(len(segment))+1.5*bar_width,female_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
#         female_delivery_number.append(number_of_delivery*solute_conversion-0.12)
#     else:
#         number_of_delivery = datalist[0]
...
# male_sup=axarr[3,0].bar(np.arange(len(segment[:6]))-0.5*bar_width,male_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue',label='Male, SNGFR inc')
# male_jux=axarr[3,0].bar(np.arange(len(segment[:6]))-0.5*bar_width,[male_delivery_jux1[i]+male_delivery_jux2[i]+male_delivery_jux3[i]+male_delivery_jux4[i]+male_delivery_jux5[i] for i in range(len(male_delivery_sup))],bar_width,bottom=male_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# male_later=axarr[3,0].bar(np.arange(len(segment))-0.5*bar_width,male_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='royalblue')

# Female_sup=axarr[3,0].bar(np.arange(len(segment[:6]))+0.5*bar_width,female_delivery_sup,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta',label='Female, SNGFR inc')
# Female_jux=axarr[3,0].bar(np.arange(len(segment[:6]))+0.5*bar_width,[female_delivery_jux1[i]+female_delivery_jux2[i]+female_delivery_jux3[i]+female_delivery_jux4[i]+female_delivery_jux5[i] for i in range(len(female_delivery_sup))],bar_width,bottom=female_delivery_sup,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later=axarr[3,0].bar(np.arange(len(segment))+0.5*bar_width,female_delivery_number,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='magenta')

# Female_sup_nhe50=axarr[3,0].bar(np.arange(len(segment[:6]))+1.5*bar_width,female_delivery_sup_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink',label='Female, "pregnancy"')
# Female_jux_nhe50=axarr[3,0].bar(np.arange(len(segment[:6]))+1.5*bar_width,[female_delivery_jux1_nhe50[i]+female_delivery_jux2_nhe50[i]+female_delivery_jux3_nhe50[i]+female_delivery_jux4_nhe50[i]+female_delivery_jux5_nhe50[i] for i in range(len(female_delivery_sup_nhe50))],bar_width,bottom=female_delivery_sup_nhe50,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='white')
# Female_later_nhe50=axarr[3,0].bar(np.arange(len(segment))+1.5*bar_width,female_delivery_number_nhe50,bar_width,align='center',alpha=0.8,linewidth=2,edgecolor='black',color='hotpink')
...
#plt.show()
plt.savefig('delivery_pregnant',bbox_inches='tight')