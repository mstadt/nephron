...
for j in range(1,N):
	...
	file_glu_apical=open('./'+file_to_save+'/'+cell[j].sex+'_'+cell[j].segment+'_glu_apical_ecd.txt','a')
	...
	file_glu_para=open('./'+file_to_save+'/'+cell[j].sex+'_'+cell[j].segment+'_glu_para_ecd.txt','a')
...
file_Na_flux_total = open('./'+file_to_save+'/'+cell[0].sex+'_'+cell[0].segment+'_Na_total_flux_'+sup_or_jux+'.txt','w')
file_Na_flux_baso = open('./'+file_to_save+'/'+cell[0].sex+'_'+cell[0].segment+'_Na_baso_flux_'+sup_or_jux+'.txt','w')
file_Na_flux_Cell_LIS = open('./'+file_to_save+'/'+cell[0].sex+'_'+cell[0].segment+'_Na_Cell_LIS_flux_'+sup_or_jux+'.txt','w')
