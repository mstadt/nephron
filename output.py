...
def output_segment_results(cell,sup_or_jux,Scaletorq,file_to_save,N):
    ...
    #========================================================
    for i in range(NS):
        file=open('./'+file_to_save+'/'+cell[0].sex+'_'+cell[0].humOrrat+'_'+cell[0].segment+'_con_of_'+solute[i]+'_in_Lumen'+sup_or_jux+'.txt','w')
        for j in range(N):
            file.write(str(cell[j].conc[i,0])+'\n')
        file.close()
    for i in range(NS):
        file=open('./'+file_to_save+'/'+cell[0].sex+'_'+cell[0].humOrrat+'_'+cell[0].segment+'_con_of_'+solute[i]+'_in_Cell'+sup_or_jux+'.txt','w')
        for j in range(N):
            file.write(str(cell[j].conc[i,1])+'\n')
        file.close()
    for i in range(NS):
        file=open('./'+file_to_save+'/'+cell[0].sex+'_'+cell[0].humOrrat+'_'+cell[0].segment+'_con_of_'+solute[i]+'_in_Bath'+sup_or_jux+'.txt','w')
        for j in range(N):
    ...
    #========================================================
    file=open('./'+file_to_save+'/'+cell[0].sex+'_'+cell[0].humOrrat+'_'+cell[0].segment+'_water_volume_in_Lumen'+sup_or_jux+'.txt','w')
    for j in range(N):
        file.write(str(cell[j].vol[0]*cw)+'\n')
    file.close()
    file=open('./'+file_to_save+'/'+cell[0].sex+'_'+cell[0].humOrrat+'_'+cell[0].segment+'_water_volume_in_Cell'+sup_or_jux+'.txt','w')
    for j in range(N):
    ...
    #========================================================
    for i in range(NS):
        file=open('./'+file_to_save+'/'+cell[0].sex+'_'+cell[0].humOrrat+'_'+cell[0].segment+'_flow_of_'+solute[i]+'_in_Lumen'+sup_or_jux+'.txt','w')
        for j in range(N):
            file.write(str(cell[j].conc[i,0]*cell[j].vol[0]*cw)+'\n')
        file.close()
    for i in range(NS):
        file=open('./'+file_to_save+'/'+cell[0].sex+'_'+cell[0].humOrrat+'_'+cell[0].segment+'_flow_of_'+solute[i]+'_in_Cell'+sup_or_jux+'.txt','w')
        for j in range(N):
    ...
    #========================================================
    file_lumen = open('./'+file_to_save+'/'+cell[0].sex+'_'+cell[0].humOrrat+'_'+cell[0].segment+'_osmolality_in_Lumen'+sup_or_jux+'.txt','w')
    file_cell = open('./'+file_to_save+'/'+cell[0].sex+'_'+cell[0].humOrrat+'_'+cell[0].segment+'_osmolality_in_Cell'+sup_or_jux+'.txt','w')
    file_lis = open('./'+file_to_save+'/'+cell[0].sex+'_'+cell[0].humOrrat+'_'+cell[0].segment+'_osmolality_in_LIS'+sup_or_jux+'.txt','w')
    file_bath = open('./'+file_to_save+'/'+cell[0].sex+'_'+cell[0].humOrrat+'_'+cell[0].segment+'_osmolality_in_Bath'+sup_or_jux+'.txt','w')
    for j in range(N):
        osm_l = 0
        osm_c = 0
        osm_lis = 0
    ...
    #========================================================
    file=open('./'+file_to_save+'/'+cell[0].sex+'_'+cell[0].humOrrat+'_'+cell[0].segment+'_pressure_in_Lumen'+sup_or_jux+'.txt','w')
    for j in range(N):
    ...
    for j in range(N):
        ...
        file_Na_apical = open('./'+file_to_save+'/'+cell[j].sex+'_'+cell[0].humOrrat+'_'+cell[j].segment+'_apical_Na'+sup_or_jux+'.txt','a')
        file_Na_apical.write(str(jsol[0,0,1])+'\n')

        file_Na_para = open('./'+file_to_save+'/'+cell[j].sex+'_'+cell[0].humOrrat+'_'+cell[j].segment+'_paracellular_Na'+sup_or_jux+'.txt','a')
            ...
            for i in range(len(cell[j].trans)):
                ...
                if transporter_type == 'SGLT1':
                    ...
                    for k in range(len(solute_id)):
                        file = open('./'+file_to_save+'/'+cell[j].sex+'_'+cell[0].humOrrat+'_'+cell[j].segment+'_'+transporter_type+'_'+solute[solute_id[k]]+sup_or_jux+'.txt','a')
                    ...
                    for k in range(len([solute_id])):
                        file = open('./'+file_to_save+'/'+cell[j].sex+'_'+cell[0].humOrrat+'_'+cell[j].segment+'_'+transporter_type+'_'+solute[solute_id]+str(memb_id[0])+str(memb_id[1])+sup_or_jux+'.txt','a')
                    ...
                    for k in range(len(solute_id)):
                        file = open('./'+file_to_save+'/'+cell[j].sex+'_'+cell[0].humOrrat+'_'+cell[j].segment+'_'+transporter_type+'_'+solute[solute_id[k]]+str(memb_id[0])+str(memb_id[1])+sup_or_jux+'.txt','a')
                        file.write(str(fluxs[k]*Scaletorq[j])+'\n')
